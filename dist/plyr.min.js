  ...
  (function (e, t) {
            ...
            [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    0 > (i = (100 / l.width) * (a.clientX - l.left)) ? (i = 0) : 100 < i && (i = 100),
            ...
            [
              {
                ...
                value: function (t) {
                  ...
                  if (
                    (M(t) || A(t)
                      ? (n = Array.from(document.querySelectorAll(A(t) ? t : 'input[type="range"]')))
                      : E(t)
                      ? (n = [t])
                      : P(t)
                      ? (n = Array.from(t))
    ...
    function ce() {
      ...
      return z(s)
        ? (Object.keys(s).forEach(function (t) {
            z(s[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, n({}, t, {})), ce(e[t], s[t]))
      ...
      Ee = {
        ...
        pip: !(
          ...
          (!X(he('video').webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled || he('video').disablePictureInPicture))
        ),
      ...
      if (e && 'addEventListener' in e && !ae(t) && X(i)) {
        ...
        Ne && (l = { passive: s, capture: r }),
          o.forEach(function (t) {
            n && n.eventListeners && a && n.eventListeners.push({ element: e, type: t, callback: i, options: l }),
    ...
    function Re(e) {
      ...
      var t = this.elements.wrapper,
        ...
        a = (100 / n[0]) * n[1];
      if (
        ((t.style.paddingBottom = ''.concat(a, '%')), this.isVimeo && !this.config.vimeo.premium && this.supported.ui)
      ) {
      ...
      if (Y(e)) {
        ...
        if (!i || !n()) {
          ...
          Je(e)
            .then(function (e) {
              ae(e) ||
                (s && window.localStorage.setItem(''.concat('cache', '-').concat(t), JSON.stringify({ content: e })),
                a(r, e));
            })
            .catch(function () {});
        }
    ...
    var nt = {
      ...
      findElements: function () {
        try {
          return (
            (this.elements.controls = Ce.call(this, this.config.selectors.controls.wrapper)),
      ...
      createButton: function (e, t) {
        ...
        return (
          s.toggle
            ? (r.appendChild(nt.createIcon.call(this, s.iconPressed, { class: 'icon--pressed' })),
              r.appendChild(nt.createIcon.call(this, s.icon, { class: 'icon--not-pressed' })),
              r.appendChild(nt.createLabel.call(this, s.labelPressed, { class: 'label--pressed' })),
              r.appendChild(nt.createLabel.call(this, s.label, { class: 'label--not-pressed' })))
            : (r.appendChild(nt.createIcon.call(this, s.icon)), r.appendChild(nt.createLabel.call(this, s.label))),
          ce(n, ye(this.config.selectors.buttons[a], n)),
          de(r, n),
          'play' === a
            ? ($(this.elements.buttons[a]) || (this.elements.buttons[a] = []), this.elements.buttons[a].push(r))
              ...
              if (!s && [32, 39].includes(n.which)) nt.showMenuPanel.call(i, t, !0);
                ...
                32 !== n.which &&
                  (40 === n.which || (s && 39 === n.which)
                    ? ((a = e.nextElementSibling), G(a) || (a = e.parentNode.firstElementChild))
                    : ((a = e.previousElementSibling), G(a) || (a = e.parentNode.lastElementChild)),
                  Ae.call(i, a, !0));
            }
          },
          !1,
      ...
      updateVolume: function () {
        this.supported.ui &&
          (G(this.elements.inputs.volume) &&
            nt.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
      ...
      durationUpdate: function () {
        if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
          ...
          !e &&
            ...
            this.paused &&
            nt.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
            ...
            var r = nt.getMenuSize.call(this, n),
              o = function t(i) {
                i.target === a &&
                  ...
                  ((a.style.width = ''), (a.style.height = ''), Ie.call(e, a, se, t));
              };
            xe.call(this, a, se, o),
      ...
      create: function (e) {
        ...
        return (
          Be($(this.config.controls) ? this.config.controls : []).forEach(function (o) {
            if (
            ...
            if (
              ('captions' === o && u.appendChild(n.call(t, 'captions', d)), 'settings' === o && !ae(t.config.settings))
            ) {
              var g = he(
                'div',
                ce({}, d, {
              ...
              b.appendChild(w),
                ...
                t.config.settings.forEach(function (n) {
                  ...
                  l.appendChild(he('span', { 'aria-hidden': !0 }, Xe(n, t.config))),
                    l.appendChild(he('span', { class: t.config.classNames.hidden }, Xe('menuBack', t.config))),
                    xe.call(
                      t,
                      o,
                      'keydown',
    ...
    var rt = {
            ...
            if (!this.isVideo || this.isYouTube || (this.isHTML5 && !Ee.textTracks))
              ...
              if (
                (G(this.elements.captions) ||
                  ((this.elements.captions = he('div', ye(this.config.selectors.captions))),
                  (function (e, t) {
        ...
        getLabel: function (e) {
          var t = e;
          return (
            !te(t) && Ee.textTracks && this.captions.toggled && (t = rt.getCurrentTrack.call(this)),
            te(t)
              ? ae(t.label)
                ? ae(t.language)
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  var e;
                  this.enabled
                    ? ((e = this.forceFallback ? 'Fallback (forced)' : t.native ? 'Native' : 'Fallback'),
                ...
                value: function () {
                  this.enabled &&
                    (oe.isIos && this.player.config.fullscreen.iosNative
                      ...
                      : this.prefix
                      ? ae(this.prefix) || this.target[''.concat(this.prefix, 'Request').concat(this.property)]()
                ...
                value: function () {
                  if (this.enabled)
                    if (oe.isIos && this.player.config.fullscreen.iosNative)
                      this.target.webkitExitFullscreen(), qe(this.player.play());
                ...
                get: function () {
                  ...
                  return (
                    ['webkit', 'moz', 'ms'].some(function (t) {
                      return (
                        !(
                          !X(document[''.concat(t, 'ExitFullscreen')]) && !X(document[''.concat(t, 'CancelFullScreen')])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
    ...
    var yt = {
        ...
        setTitle: function () {
          ...
          if (
            (Y(this.config.title) && !ae(this.config.title) && (e += ', '.concat(this.config.title)),
                  ...
                  xe.call(
                    ...
                    function (t) {
                      ...
                      ['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                        (yt.toggleControls.call(e, !0), (s = e.touch ? 3e3 : 2e3)),
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  i = t.elements;
                if (
                  (xe.call(t, t.media, 'timeupdate seeking seeked', function (e) {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  this.bind(
                    ...
                    function (e) {
                      ...
                      [13, 32].includes(i) &&
                        (13 !== i
                          ? (e.preventDefault(), e.stopPropagation(), nt.toggleMenu.call(t, e))
                  ...
                  this.bind(i.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', function (e) {
                    ...
                    if (!ee(e) || 39 === n || 37 === n) {
                      ...
                      a && s
                        ...
                        : !s && t.playing && (i.setAttribute('play-on-seeked', ''), t.pause());
                    }
                  }),
                  oe.isIos)
                ) {
                ...
                this.bind(
                  ...
                  oe.isWebkit &&
                    Array.from(Te.call(t, 'input[type="range"]')).forEach(function (i) {
    ...
    var Tt = {
      ...
      ready: function () {
        ...
        Je(Ue(t.config.urls.vimeo.api, h), 'json').then(function (e) {
          ...
          (t.embed = new window.Vimeo.Player(p, { autopause: t.config.autopause, muted: t.muted })),
          (t.media.paused = !0),
    ...
    var St = {
                    ...
                    (e.options.speed = r.filter(function (t) {
                      ...
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = i.getVideoLoadedFraction()),
                          ...
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering), Oe.call(e, e.media, 'canplaythrough'));
                      }, 200)),
                      setTimeout(function () {
                    ...
                    case 1:
                      e.config.autoplay || !e.media.paused || e.embed.hasPlayed
                        ? (Ct.call(e, !0),
                          ...
                          e.media.duration !== i.getDuration() &&
                            ((e.media.duration = i.getDuration()), Oe.call(e, e.media, 'durationchange')))
                        : e.media.pause();
                      break;
                    case 2:
      ...
      Pt = {
        setup: function () {
          this.media
            ? (be(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
              ...
              this.isVideo &&
                ((this.elements.wrapper = he('div', { class: this.config.classNames.video })),
                ue(this.media, this.elements.wrapper),
                (this.elements.poster = he('div', { class: this.config.classNames.poster })),
        ...
        return (
          i(t, [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.elements.container = he('div', { class: this.player.config.classNames.ads })),
              ...
              value: function () {
                ...
                (this.mouseDown = !1),
                  Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime)
                    ...
                    : Le.call(this.player, this.player.media, 'timeupdate', function () {
            ...
            },
            {
              ...
              value: function (e, t, i, n, a) {
                ...
                this.player.debug.log(
                  'Showing thumb: '.concat(a, '. num: ').concat(n, '. qual: ').concat(i, '. newimg: ').concat(s),
                ),
                    ...
                    s < this.thumbContainerHeight &&
                      setTimeout(function () {
                        a.showingThumbFilename === n &&
                          (a.player.debug.log('Showing higher quality thumb for: '.concat(n)), a.loadImage(e + 1));
                      }, 300);
                }
              },
            },
      ...
      Lt = (function () {
        function t(i, n) {
          ...
          if (
            ...
            ((window.jQuery && this.media instanceof jQuery) || J(this.media) || $(this.media)) &&
                    ...
                    if (((o = this.media.querySelector('iframe')), G(o))) {
                      if (
                        ...
                        c.includes(l.searchParams.get('autoplay')) && (this.config.autoplay = !0),
                          ...
                          this.isYouTube
                            ? ((this.config.playsinline = c.includes(l.searchParams.get('playsinline'))),
                ...
                (this.supported = Ee.check(this.type, this.provider, this.config.playsinline)),
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      Pt.setup.call(this),
                      this.config.debug &&
                        xe.call(this, this.elements.container, this.config.events.join(' '), function (e) {
                      ...
                      (this.lastSeekTime = 0),
                      this.config.previewThumbnails.enabled && (this.previewThumbnails = new Mt(this)))
