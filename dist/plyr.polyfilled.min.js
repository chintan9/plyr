  ...
  (function (e, t) {
      ...
      ee = t(function (e) {
        ...
        (e.exports = function (e, t, a, o) {
          ...
          'function' == typeof a &&
            ...
            e !== i
              ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : O(e, t, a))
              : l
              ? (e[t] = a)
              : I(t, a);
    ...
    var ir = Xe('iterator'),
      ...
      Wr = function () {
        ...
        var e,
          ...
          h = [];
        if (
          (Or(u, { type: 'URLSearchParams', entries: h, updateURL: function () {}, updateSearchParams: Br }),
          void 0 !== c)
        )
          if (g(c))
    ...
    Er(
      Kr,
      {
        ...
        forEach: function (e) {
          for (
            var t, n = Ir(this).entries, i = rt(e, arguments.length > 1 ? arguments[1] : void 0, 3), r = 0;
            r < n.length;
    ...
    var $r,
      ...
      ma = function (e) {
        ...
        for (n = [], i = 0; i < t; i++) {
          ...
          if (
            ((a = 10),
            r.length > 1 && '0' == r.charAt(0) && ((a = oa.test(r) ? 16 : 8), (r = r.slice(8 == a ? 1 : 2))),
            '' === r)
          )
            o = 0;
          else {
          ...
          switch (((a = r[u]), c)) {
            ...
            case ja:
              if (a && (ra.test(a) || '+' == a || '-' == a || '.' == a)) h += a.toLowerCase();
                ...
                if (
                  n &&
                  (Ea(e) != b(Sa, h) || ('file' == h && (Aa(e) || null !== e.port)) || ('file' == e.scheme && !e.host))
                )
                  return;
              ...
              var t = e.URL,
                n = function (t, n) {
                  ...
                  Object.defineProperty(this, '_updateSearchParams', {
                    ...
                    value: function () {
                      this.search !== u &&
                        ((u = this.search), l && ((s = !1), this.searchParams._fromString(this.search), (s = !0)));
                    },
                  });
                },
                i = n.prototype;
    ...
    Ie(
      { target: 'Number', proto: !0, forced: Vs },
      {
        toFixed: function (e) {
          ...
          return (c =
            o > 0
              ? l + ((r = c.length) <= o ? '0.' + Fs.call('0', o - r) + c : c.slice(0, r - o) + '.' + c.slice(r - o))
              : l + c);
        },
      },
    );
    ...
    function Tu() {
      ...
      return eu(r)
        ? (Object.keys(r).forEach(function (t) {
            eu(r[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, ko({}, t, {})), Tu(e[t], r[t]))
    ...
    function Zu(e) {
      ...
      var t = this.elements.wrapper,
        ...
        r = (100 / i[0]) * i[1];
      if (
        ((t.style.paddingBottom = ''.concat(r, '%')), this.isVimeo && !this.config.vimeo.premium && this.supported.ui)
      ) {
      ...
      if (nu(e)) {
        ...
        if (!n || !i()) {
          ...
          Eh(e)
            .then(function (e) {
              du(e) ||
                (a && window.localStorage.setItem(''.concat('cache', '-').concat(t), JSON.stringify({ content: e })),
                r(o, e));
            })
            .catch(function () {});
        }
      ...
      updateVolume: function () {
        this.supported.ui &&
          (su(this.elements.inputs.volume) &&
            jh.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
      ...
      durationUpdate: function () {
        if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
          if (this.duration >= Math.pow(2, 32))
            return Lu(this.elements.display.currentTime, !0), void Lu(this.elements.progress, !0);
      ...
      create: function (e) {
        ...
        return (
          th(au(this.config.controls) ? this.config.controls : []).forEach(function (s) {
            ...
            if (
              ('captions' === s && u.appendChild(i.call(t, 'captions', h)), 'settings' === s && !du(t.config.settings))
            ) {
              var g = Au(
                'div',
                Tu({}, h, {
                ...
                value: function () {
                  if (this.enabled)
                    if (gu.isIos && this.player.config.fullscreen.iosNative)
                      this.target.webkitExitFullscreen(), Gu(this.player.play());
              ...
              },
              {
                ...
                get: function () {
                  ...
                  if (!e.native || this.forceFallback)
                    return Nu(this.target, this.player.config.classNames.fullscreen.fallback);
                  var t = this.prefix
                  ...
                  Vu.call(
                    ...
                    function (t) {
                      ...
                      ['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                        ($h.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
    ...
    var of = {
        setup: function () {
          var e = this;
          if ((ju(this.elements.wrapper, this.config.classNames.embed, !0), eu(window.YT) && ru(window.YT.Player)))
            of.ready.call(this);
          else {
                    ...
                    (e.options.speed = o.filter(function (t) {
                      ...
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = n.getVideoLoadedFraction()),
                          ...
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering), Ku.call(e, e.media, 'canplaythrough'));
                      }, 200)),
                      setTimeout(function () {
            ...
            },
            {
              ...
              value: function (e, t, n, i, r) {
                ...
                this.player.debug.log(
                  'Showing thumb: '.concat(r, '. num: ').concat(i, '. qual: ').concat(n, '. newimg: ').concat(a),
                ),
      ...
      Tf = (function () {
        function e(t, n) {
          ...
          if (
            ...
            ((window.jQuery && this.media instanceof jQuery) || ou(this.media) || au(this.media)) &&
