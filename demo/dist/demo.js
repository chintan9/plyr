typeof navigator === "object" && (function () {
  ...
  var objectPropertyIsEnumerable = {f : f};
  ...
  var classofRaw = function(it) { return toString.call(it).slice(8, -1); };
  ...
  var toPrimitive = function(input, PREFERRED_STRING) {
    ...
    if (PREFERRED_STRING && typeof (fn = input.toString) == 'function' &&
      ...
      return val;
    if (typeof (fn = input.valueOf) == 'function' &&
        !isObject(val = fn.call(input)))
      return val;
    if (!PREFERRED_STRING && typeof (fn = input.toString) == 'function' &&
        !isObject(val = fn.call(input)))
  ...
  var has = function(it, key) { return hasOwnProperty.call(it, key); };

  var document$1 = global_1.document;
  // typeof document.createElement is 'object' in old IE
  var EXISTS = isObject(document$1) && isObject(document$1.createElement);

  var documentCreateElement = function(
      it) { return EXISTS ? document$1.createElement(it) : {}; };

  // Thank's IE8 for his funny defineProperty
  var ie8DomDefine = !descriptors && !fails(function() {
    return Object
               .defineProperty(documentCreateElement('div'), 'a',
  ...
  var objectGetOwnPropertyDescriptor = {f : f$1};
  ...
  var f$2 = descriptors ? nativeDefineProperty
  ...
  var objectDefineProperty = {f : f$2};
  ...
  if (typeof sharedStore.inspectSource != 'function') {
    sharedStore.inspectSource = function(
        it) { return functionToString.call(it); };
  }
  ...
  var nativeWeakMap = typeof WeakMap$1 === 'function' &&
  ...
  var sharedKey = function(key) { return keys[key] || (keys[key] = uid(key)); };
  ...
  var enforce = function(it) { return has$1(it) ? get(it) : set(it, {}); };
  ...
  if (nativeWeakMap) {
    ...
    get = function(it) { return wmget.call(store$1, it) || {}; };
    ...
    get = function(it) { return has(it, STATE) ? it[STATE] : {}; };
  ...
  var redefine = createCommonjsModule(function(module) {
    ...
    (module.exports = function(O, key, value, options) {
      ...
      if (typeof value == 'function') {
        ...
        enforceInternalState(value).source =
            TEMPLATE.join(typeof key == 'string' ? key : '');
      }
      if (O === global_1) {
        if (simple)
          O[key] = value;
      ...
      // add fake Function#toString for correct work wrapped methods /
      // constructors with methods like LoDash isNative
  ...
  var toLength = function(argument) {
    return argument > 0 ? min(toInteger(argument), 0x1FFFFFFFFFFFFF)
  ...
  // If integer < 0, let result be max((length + integer), 0); else let result
  // be min(integer, length).
  ...
  var f$3 = Object.getOwnPropertyNames ||
            function getOwnPropertyNames(
                O) { return objectKeysInternal(O, hiddenKeys$1); };

  var objectGetOwnPropertyNames = {f : f$3};

  var f$4 = Object.getOwnPropertySymbols;

  var objectGetOwnPropertySymbols = {f : f$4};
  ...
  /*
    ...
    options.bind        - bind methods to the target, required for the `pure`
    version options.wrap        - wrap constructors to preventing global
    pollution, required for the `pure` version options.unsafe      - use the
    simple assignment of property instead of delete + defineProperty
  ...
  */
  ...
  var functionBindContext = function(fn, that, length) {
    ...
    return function(/* ...args */) { return fn.apply(that, arguments); };
  };
  ...
  var isArray =
      Array.isArray || function isArray(
                           arg) { return classofRaw(arg) == 'Array'; };
  ...
  var createWellKnownSymbol =
      useSymbolAsUid ? Symbol$1 : Symbol$1 && Symbol$1.withoutSetter || uid;
  ...
  var arrayFrom = function from(
    ...
    if (mapping)
      mapfn = functionBindContext(
          mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2);
    // if the target is not iterable or it's an array with the default iterator
    // - use a simple case
  ...
  try {
    ...
    iteratorWithReturn[ITERATOR$2] = function() { return this; };
  ...
  var objectKeys =
      Object.keys || function keys(
                         O) { return objectKeysInternal(O, enumBugKeys); };
  ...
  var scriptTag = function(
      content) { return LT + SCRIPT + GT + content + LT + '/' + SCRIPT + GT; };

  // Create object with fake `null` prototype: use ActiveX Object with cleared
  // prototype
  ...
  var addToUnscopables = function(
      key) { ArrayPrototype$1[UNSCOPABLES][key] = true; };

  var $includes = arrayIncludes.includes;

  var USES_TO_LENGTH$1 =
      arrayMethodUsesToLength('indexOf', {ACCESSORS : true, 1 : 0});
  ...
  _export({target : 'Object', stat : true, forced : FAILS_ON_PRIMITIVES},
          {keys : function keys(it) { return objectKeys(toObject(it)); }});
  ...
  var isRegexp = function(it) {
    var isRegExp;
    return isObject(it) &&
           ((isRegExp = it[MATCH]) !== undefined ? !!isRegExp
  ...
  },
          {
            includes : function includes(searchString /* , position = 0 */) {
              return !!~String(requireObjectCoercible(this))
                            .indexOf(notARegexp(searchString),
  ...
  var objectGetPrototypeOf =
      correctPrototypeGetter ? Object.getPrototypeOf : function(O) {
        O = toObject(O);
        if (has(O, IE_PROTO$1))
          return O[IE_PROTO$1];
  ...
  if ([].keys) {
    ...
    if (!('next' in arrayIterator))
      ...
      PrototypeOfArrayIteratorPrototype =
          objectGetPrototypeOf(objectGetPrototypeOf(arrayIterator));
  ...
  var createIteratorConstructor = function(IteratorConstructor, NAME, next) {
    ...
    IteratorConstructor.prototype = objectCreate(
        IteratorPrototype$1, {next : createPropertyDescriptor(1, next)});
  ...
  var defineIterator = function(Iterable, NAME, IteratorConstructor, next,
    ...
    var defaultIterator = !BUGGY_SAFARI_ITERATORS$1 && nativeIterator ||
    ...
    if (anyNativeIterator) {
      CurrentIteratorPrototype =
          objectGetPrototypeOf(anyNativeIterator.call(new Iterable()));
      if (IteratorPrototype$2 !== Object.prototype &&
          CurrentIteratorPrototype.next) {
        if (objectGetPrototypeOf(CurrentIteratorPrototype) !==
            IteratorPrototype$2) {
          if (objectSetPrototypeOf) {
            objectSetPrototypeOf(CurrentIteratorPrototype, IteratorPrototype$2);
          } else if (typeof CurrentIteratorPrototype[ITERATOR$4] !=
                     'function') {
            createNonEnumerableProperty(CurrentIteratorPrototype, ITERATOR$4,
                                        returnThis$2);
          }
        }
    ...
    if (IterablePrototype[ITERATOR$4] !== defaultIterator) {
      createNonEnumerableProperty(IterablePrototype, ITERATOR$4,
                                  defaultIterator);
    }
    ...
    if (DEFAULT) {
      ...
      if (FORCED)
        for (KEY in methods) {
          if (BUGGY_SAFARI_ITERATORS$1 || INCORRECT_VALUES_NAME ||
  ...
  defineIterator(
      ...
      function(iterated) {
        setInternalState(
            this,
            {type : STRING_ITERATOR, string : String(iterated), index : 0});
  ...
  var objectGetOwnPropertyNamesExternal = {f : f$5};

  var f$6 = wellKnownSymbol;

  var wellKnownSymbolWrapped = {f : f$6};
  ...
  var defineWellKnownSymbol = function(NAME) {
    ...
    if (!has(Symbol, NAME))
      defineProperty$2(Symbol, NAME, {value : wellKnownSymbolWrapped.f(NAME)});
  };
  ...
  var isSymbol = useSymbolAsUid
                     ...
                     : function(it) { return Object(it) instanceof $Symbol; };
  ...
  var $propertyIsEnumerable = function propertyIsEnumerable(V) {
    ...
    if (this === ObjectPrototype$1 && has(AllSymbols, P) &&
        !has(ObjectPrototypeSymbols, P))
      return false;
    return enumerable || !has(this, P) || !has(AllSymbols, P) ||
  ...
  var $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(O, P) {
    ...
    var key = toPrimitive(P, true);
    if (it === ObjectPrototype$1 && has(AllSymbols, key) &&
        !has(ObjectPrototypeSymbols, key))
      return;
    var descriptor = nativeGetOwnPropertyDescriptor$1(it, key);
    if (descriptor && has(AllSymbols, key) &&
  ...
  if (!nativeSymbol) {
    ...
    redefine($Symbol[PROTOTYPE$1], 'toString',
             function toString() { return getInternalState$1(this).tag; });

    redefine(
        $Symbol, 'withoutSetter',
        function(description) { return wrap(uid(description), description); });
    ...
    wellKnownSymbolWrapped.f = function(
    ...
    if (descriptors) {
      ...
      nativeDefineProperty$1($Symbol[PROTOTYPE$1], 'description', {
        configurable : true,
        get : function
            description() { return getInternalState$1(this).description; }
      });
      {
        redefine(ObjectPrototype$1, 'propertyIsEnumerable',
  ...
  $forEach$1(objectKeys(WellKnownSymbolsStore$1),
  ...
  _export({
    target : 'Object',
    stat : true,
    forced : fails(function() { objectGetOwnPropertySymbols.f(1); })
  },
          {
            getOwnPropertySymbols : function getOwnPropertySymbols(
                it) { return objectGetOwnPropertySymbols.f(toObject(it)); }
          });
  ...
  if (!$Symbol[PROTOTYPE$1][TO_PRIMITIVE]) {
    createNonEnumerableProperty($Symbol[PROTOTYPE$1], TO_PRIMITIVE,
  ...
  if (descriptors && typeof NativeSymbol == 'function' &&
    ...
    var SymbolWrapper = function Symbol() {
      var description = arguments.length < 1 || arguments[0] === undefined
                            ? undefined
                            : String(arguments[0]);
      var result =
          this instanceof SymbolWrapper
              ...
              : description === undefined ? NativeSymbol()
    ...
    forced : ES3_STRINGS || !STRICT_METHOD$2
  },
          {
            join : function join(separator) {
              return nativeJoin.call(toIndexedObject(this),
  ...
  var arrayMethodHasSpeciesSupport = function(METHOD_NAME) {
    ...
    return engineV8Version >= 51 || !fails(function() {
             ...
             constructor[SPECIES$1] = function() { return {foo : 1}; };
             return array[METHOD_NAME](Boolean).foo !== 1;
           });
  };

  var HAS_SPECIES_SUPPORT = arrayMethodHasSpeciesSupport('slice');
  var USES_TO_LENGTH$3 =
      arrayMethodUsesToLength('slice', {ACCESSORS : true, 0 : 0, 1 : 2});
    ...
    forced : !HAS_SPECIES_SUPPORT || !USES_TO_LENGTH$3
  },
          {
            slice : function slice(start, end) {
              ...
              var fin =
                  toAbsoluteIndex(end === undefined ? length : end, length);
              // inline `ArraySpeciesCreate` for usage native `Array#slice`
              // where it's possible
  ...
  var UNSUPPORTED_Y = fails(function() {
    // babel-minify transpiles RegExp('a', 'y') -> /a/y and it causes
    // SyntaxError
    var re = RE('a', 'y');
    re.lastIndex = 2;
  ...
  // nonparticipating capturing group, copied from es5-shim's String#split
  // patch.
  ...
  if (PATCH) {
    patchedExec = function exec(str) {
      ...
      if (NPCG_INCLUDED && match && match.length > 1) {
        ...
        // `undefined` for NPCG, like IE8. NOTE: This doesn' work for /(.?)?/
  ...
  if (NOT_GENERIC || INCORRECT_NAME) {
    redefine(RegExp.prototype, TO_STRING, function toString() {
      ...
      var rf = R.flags;
      var f = String(rf === undefined && R instanceof RegExp &&
  ...
  // Chrome 51 has a buggy "split" implementation when RegExp#exec !==
  // nativeExec Weex JS has frozen built-in prototypes, so use try / catch
  // wrapper
  ...
  var fixRegexpWellKnownSymbolLogic = function(KEY, length, exec, sham) {
    ...
    var DELEGATES_TO_EXEC =
        DELEGATES_TO_SYMBOL && !fails(function() {
          ...
          if (KEY === 'split') {
            ...
            re = {};
            // RegExp[@@split] doesn't call the regex's exec method, but first
            // creates a new one. We need to return the patched regex when
    ...
    if (!DELEGATES_TO_SYMBOL || !DELEGATES_TO_EXEC ||
        (KEY === 'replace' &&
               ...
               function(nativeMethod, regexp, str, arg2, forceStringMethod) {
                 if (regexp.exec === regexpExec) {
                   if (DELEGATES_TO_SYMBOL && !forceStringMethod) {
                     // The native String method already delegates to @@method
                     // (this polyfilled function), leasing to infinite
                     // recursion. We avoid it by directly calling the native
                     // @@method method.
                     return {
                       done : true,
      ...
      redefine(
          ...
          length == 2
              ...
              ? function(string,
                         arg) { return regexMethod.call(string, this, arg); }
  ...
  var advanceStringIndex = function(
      S, index,
      unicode) { return index + (unicode ? charAt$1(S, index).length : 1); };
  ...
  var maybeToString = function(
      it) { return it === undefined ? it : String(it); };

  // @@replace logic
  fixRegexpWellKnownSymbolLogic(
      'replace', 2, function(REPLACE, nativeReplace, maybeCallNative, reason) {
        ...
        return [
          ...
          function replace(searchValue, replaceValue) {
            ...
            return replacer !== undefined
                       ...
                       : nativeReplace.call(String(O), searchValue,
                                            replaceValue);
          },
          // `RegExp.prototype[@@replace]` method
          // https://tc39.github.io/ecma262/#sec-regexp.prototype-@@replace
          function(regexp, replaceValue) {
            if ((!REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE &&
                 REPLACE_KEEPS_$0) ||
                (typeof replaceValue === 'string' &&
                 replaceValue.indexOf(UNSAFE_SUBSTITUTE) === -1)) {
              var res =
                  maybeCallNative(nativeReplace, regexp, this, replaceValue);
              if (res.done)
                return res.value;
            }
            ...
            while (true) {
              ...
              if (matchStr === '')
                rx.lastIndex =
                    advanceStringIndex(S, toLength(rx.lastIndex), fullUnicode);
            }
            ...
            for (var i = 0; i < results.length; i++) {
              ...
              // but for some reason `nativeSlice.call(result, 1,
              // result.length)` (called in the slice polyfill when slicing
              // native arrays) "doesn't work" in safari 9 and causes a crash
              // (https://pastebin.com/N21QzeQA) when trying to debug it.
              ...
              if (functionalReplace) {
                ...
                var replacement =
                    String(replaceValue.apply(undefined, replacerArgs));
              } else {
  ...
  // @@search logic
  fixRegexpWellKnownSymbolLogic(
      'search', 1, function(SEARCH, nativeSearch, maybeCallNative) {
        return [
  ...
  // @@split logic
  fixRegexpWellKnownSymbolLogic(
      'split', 2, function(SPLIT, nativeSplit, maybeCallNative) {
        var internalSplit;
        if ('abbc'.split(/(b)*/)[1] == 'c' ||
            'test'.split(/(?:)/, -1).length != 4 ||
            'ab'.split(/(?:ab)*/).length != 2 ||
            '.'.split(/(.?)(.?)/).length != 4 || '.'.split(/()()/).length > 1 ||
            ''.split(/.?/).length) {
        ...
        return [
          ...
          //
          // NOTE: This cannot be properly polyfilled in engines that don't
          // support the 'y' flag.
          function(regexp, limit) {
            ...
            // simulate the 'y' flag.
            var splitter =
                new C(SUPPORTS_Y ? rx : '^(?:' + rx.source + ')', flags);
            var lim = limit === undefined ? MAX_UINT32 : limit >>> 0;
            if (lim === 0)
              return [];
            if (S.length === 0)
            ...
            while (q < S.length) {
              ...
              var e;
              if (z === null || (e = min$3(toLength(splitter.lastIndex +
                                                    (SUPPORTS_Y ? 0 : q)),
                                           S.length)) === p) {
  ...
  for (var COLLECTION_NAME$1 in domIterables) {
    ...
    if (CollectionPrototype$1) {
      ...
      if (CollectionPrototype$1[ITERATOR$5] !== ArrayValues)
        try {
          createNonEnumerableProperty(CollectionPrototype$1, ITERATOR$5,
                                      ArrayValues);
        } catch (error) {
          CollectionPrototype$1[ITERATOR$5] = ArrayValues;
        }
      if (!CollectionPrototype$1[TO_STRING_TAG$3]) {
        createNonEnumerableProperty(CollectionPrototype$1, TO_STRING_TAG$3,
                                    COLLECTION_NAME$1);
      }
      if (domIterables[COLLECTION_NAME$1])
        for (var METHOD_NAME in es_array_iterator) {
          // some Chrome versions have non-configurable methods on DOMTokenList
          if (CollectionPrototype$1[METHOD_NAME] !==
              es_array_iterator[METHOD_NAME])
            try {
              createNonEnumerableProperty(CollectionPrototype$1, METHOD_NAME,
                                          es_array_iterator[METHOD_NAME]);
            } catch (error) {
  ...
  var nativeUrl = !fails(function() {
    ...
    return (isPure && !url.toJSON) || !searchParams.sort ||
  ...
  var encode = function(input) {
    ...
    var handledCPCount =
        basicLength; // number of code points that have been handled;
  ...
  var stringPunycodeToAscii = function(input) {
    var encoded = [];
    var labels =
        input.toLowerCase().replace(regexSeparators, '\u002E').split('.');
    var i, label;
  ...
  // TODO: in core-js@4, move /modules/ dependencies to public entries for
  // better optimization by tools like `preset-env`
  ...
  var getInternalIteratorState =
      internalState.getterFor(URL_SEARCH_PARAMS_ITERATOR);
  ...
  var replacer = function(match) { return replace[match]; };

  var serialize = function(
      it) { return encodeURIComponent(it).replace(find, replacer); };
  ...
  var URLSearchParamsIterator = createIteratorConstructor(
      ...
      function next() {
        ...
        if (!step.done) {
          step.value = kind === 'keys'
                           ? entry.key
                           : kind === 'values' ? entry.value
  ...
  var URLSearchParamsConstructor = function URLSearchParams(/* init */) {
    ...
    var that = this;
    var entries = [];
    var iteratorMethod, iterator, next, step, entryIterator, entryNext, first,
        second, key;
  ...
  redefineAll(URLSearchParamsPrototype, {
    ...
    forEach : function forEach(callback /* , thisArg */) {
      ...
      var boundFunction = functionBindContext(
          callback, arguments.length > 1 ? arguments[1] : undefined, 3);
      var index = 0;
      var entry;
      while (index < entries.length) {
        entry = entries[index++];
    ...
    keys :
        function keys() { return new URLSearchParamsIterator(this, 'keys'); },
    // `URLSearchParams.prototype.values` method
    values : function
        values() { return new URLSearchParamsIterator(this, 'values'); },
    // `URLSearchParams.prototype.entries` method
    entries : function
        entries() { return new URLSearchParamsIterator(this, 'entries'); }
  },
              {enumerable : true});

  // `URLSearchParams.prototype[@@iterator]` method
  redefine(URLSearchParamsPrototype, ITERATOR$7,
        ...
        if (arguments.length > 1) {
          ...
          if (isObject(init)) {
            ...
            if (classof(body) === URL_SEARCH_PARAMS) {
              headers =
                  init.headers ? new Headers$1(init.headers) : new Headers$1();
  ...
  var parseIPv6 = function(input) {
    ...
    var char = function() { return input.charAt(pointer); };
  ...
  var isSpecial = function(url) { return has(specialSchemes, url.scheme); };

  var includesCredentials = function(
      url) { return url.username != '' || url.password != ''; };
  ...
  var shortenURLsPath = function(url) {
    ...
    if (pathSize && (url.scheme != 'file' || pathSize != 1 ||
  ...
  var isSingleDot = function(
      segment) { return segment === '.' || segment.toLowerCase() === '%2e'; };
  ...
  var parseURL = function(url, input, stateOverride, base) {
    ...
    while (pointer <= codePoints.length) {
      ...
      case SCHEME:
        if (char && (ALPHANUMERIC.test(char) || char == '+' || char == '-' ||
                     char == '.')) {
          buffer += char.toLowerCase();
        } else if (char == ':') {
          if (stateOverride &&
        ...
        if (char == '@') {
          ...
          for (var i = 0; i < bufferCodePoints.length; i++) {
            ...
            var encodedCodePoints =
                percentEncode(codePoint, userinfoPercentEncodeSet);
      ...
      case PORT:
        if (DIGIT.test(char)) {
          buffer += char;
                   ...
                   (char == '\\' && isSpecial(url)) || stateOverride) {
          if (buffer != '') {
      ...
      case PATH:
        if (char == EOF || char == '/' || (char == '\\' && isSpecial(url)) ||
          ...
          if (isDoubleDot(buffer)) {
            ...
            if (url.scheme == 'file' && !url.path.length &&
  ...
  var URLConstructor = function URL(url /* , base */) {
    ...
    searchParamsState.updateURL =
        function() { state.query = String(searchParams) || null; };
    if (!descriptors) {
  ...
  var serializeURL = function() {
    ...
    if (host !== null) {
      ...
      output += '//';
    output += url.cannotBeABaseURL ? path[0]
  ...
  var getOrigin = function() {
    ...
    if (scheme == 'file' || !isSpecial(url))
      return 'null';
    return scheme + '://' + serializeHost(url.host) +
           (port !== null ? ':' + port : '');
  };

  var getProtocol =
      function() { return getInternalURLState(this).scheme + ':'; };

  var getUsername = function() { return getInternalURLState(this).username; };

  var getPassword = function() { return getInternalURLState(this).password; };
  ...
  var getPathname = function() {
    var url = getInternalURLState(this);
    var path = url.path;
    return url.cannotBeABaseURL ? path[0]
                                : path.length ? '/' + path.join('/') : '';
  };
  ...
  var getSearchParams =
      function() { return getInternalURLState(this).searchParams; };
  ...
  if (descriptors) {
    objectDefineProperties(URLPrototype, {
      ...
      href : accessorDescriptor(serializeURL,
                                function(href) {
                                  var url = getInternalURLState(this);
                                  ...
                                  if (failure)
                                    throw TypeError(failure);
                                  getInternalSearchParamsState(url.searchParams)
      ...
      username : accessorDescriptor(
          ...
          function(username) {
            ...
            for (var i = 0; i < codePoints.length; i++) {
              url.username +=
                  percentEncode(codePoints[i], userinfoPercentEncodeSet);
            }
          }),
  ...
  redefine(URLPrototype, 'toJSON',
           function toJSON() { return serializeURL.call(this); },
           {enumerable : true});

  // `URL.prototype.toString` method
  // https://url.spec.whatwg.org/#URL-stringification-behavior
  redefine(URLPrototype, 'toString',
           function toString() { return serializeURL.call(this); },
           {enumerable : true});
  ...
  if (NativeURL) {
    ...
    if (nativeCreateObjectURL)
      redefine(URLConstructor, 'createObjectURL',
    ...
    if (nativeRevokeObjectURL)
      redefine(URLConstructor, 'revokeObjectURL',
  ...
  (function(global) {
    ...
    /**
     * Search param name and values should be encoded according to
     * https://url.spec.whatwg.org/#urlencoded-serializing encodeURIComponent()
     * produces the same result except encoding spaces as `%20` instead of `+`.
     */

    var serializeParam = function serializeParam(
        value) { return encodeURIComponent(value).replace(/%20/g, '+'); };
    ...
    var polyfillURLSearchParams = function polyfillURLSearchParams() {
      var URLSearchParams = function URLSearchParams(searchString) {
        ...
        if (typeofSearchString === 'undefined')
          ...
          searchString.forEach(function(value,
                                        name) { _this.append(name, value); });
        } else if (searchString !== null && typeofSearchString === 'object') {
          if (Object.prototype.toString.call(searchString) ===
              '[object Array]') {
            for (var i = 0; i < searchString.length; i++) {
              ...
              if (Object.prototype.toString.call(entry) === '[object Array]' ||
                ...
                throw new TypeError(
                    'Expected [string, any] as entry at index ' + i +
      ...
      proto.delete = function(name) { delete this._entries[name]; };
      ...
      proto.has = function(name) { return name in this._entries; };

      proto.set = function(name,
                           value) { this._entries[name] = [ String(value) ]; };
    ...
    var checkIfURLSearchParamsSupported =
        function checkIfURLSearchParamsSupported() {
      try {
        var URLSearchParams = global.URLSearchParams;
        return new URLSearchParams('?a=1').toString() === 'a=1' &&
      ...
      Object.defineProperty(proto, '_fromString', {
        ...
        value : function value(searchString) {
          if (this._entries) {
            ...
            var keys = [];
            this.forEach(function(value, name) { keys.push(name); });
          ...
          for (var i = 0; i < attributes.length; i++) {
            ...
            this.append(deserializeParam(attribute[0]),
    ...
    var polyfillURL = function polyfillURL() {
      ...
      var URL = function URL(url, base) {
        if (typeof url !== 'string')
          url = String(url); // Only create another document if the base is
        ...
        if (base &&
          ...
          try {
            ...
            throw new Error('URL unable to set base ' + base + ' due to ' +
                            err);
          }
        }
        ...
        Object.defineProperty(this, 'searchParams',
                              {value : searchParams, enumerable : true});
        var search = void 0;
      ...
      var linkURLWithAnchorAttribute = function linkURLWithAnchorAttribute(
        ...
        Object.defineProperty(proto, attributeName, {
          get : function get() { return this._anchorElement[attributeName]; },
          set : function set(
              value) { this._anchorElement[attributeName] = value; },
          enumerable : true
        });
      };

      ['hash', 'host', 'hostname', 'port', 'protocol'].forEach(function(
          attributeName) { linkURLWithAnchorAttribute(attributeName); });
      Object.defineProperty(proto, 'search', {
        get : function get() { return this._anchorElement['search']; },
      ...
      Object.defineProperties(proto, {
        'toString' : {
          get : function get() {
            ...
            return function() { return _this.href; };
          }
        },
        'href' : {
          get : function
              get() { return this._anchorElement.href.replace(/\?$/, ''); },
          set : function set(value) {
        ...
        'pathname' : {
          ...
          set : function set(value) { this._anchorElement.pathname = value; },
          enumerable : true
        },
        'origin' : {
          get : function get() {
            ...
            var expectedPort = {
              ...
              'https:' : 443,
              'ftp:' : 21
            }[this._anchorElement.protocol]; // add port to origin if, expected
                                             // port is different than actual
                                             // port
      ...
      URL.createObjectURL = function(
          blob) { return _URL.createObjectURL.apply(_URL, arguments); };

      URL.revokeObjectURL = function(
          url) { return _URL.revokeObjectURL.apply(_URL, arguments); };
    ...
    if (global.location !== void 0 && !('origin' in global.location)) {
      ...
      try {
        Object.defineProperty(global.location, 'origin',
                              {get : getOrigin, enumerable : true});
      } catch (e) {
        setInterval(function() { global.location.origin = getOrigin(); }, 100);
      }
    }
  })(typeof commonjsGlobal !== 'undefined'
         ? commonjsGlobal
  ...
  var IS_CONCAT_SPREADABLE_SUPPORT =
      engineV8Version >= 51 || !fails(function() {
        var array = [];
  ...
  var arrayFill = function fill(value /* , start = 0, end = @length */) {
    ...
    var argumentsLength = arguments.length;
    var index =
        toAbsoluteIndex(argumentsLength > 1 ? arguments[1] : undefined, length);
  ...
  // For preventing possible almost infinite loop in non-standard
  // implementations, test the forward version of the method
  var USES_TO_LENGTH$4 =
      arrayMethodUsesToLength('indexOf', {ACCESSORS : true, 1 : 0});
  ...
  var iterate_1 = createCommonjsModule(function(module) {
        ...
        module.exports = function(iterable, fn, that, AS_ENTRIES, IS_ITERATOR) {
          ...
          if (IS_ITERATOR) {
            ...
            if (isArrayIteratorMethod(iterFn)) {
              for (index = 0, length = toLength(iterable.length);
                   length > index; index++) {
                result = AS_ENTRIES
                             ? boundFunction(
                                   anObject(step = iterable[index])[0], step[1])
          ...
          next = iterator.next;
          while (!(step = next.call(iterator)).done) {
            result = callWithSafeIterationClosing(iterator, boundFunction,
                                                  step.value, AS_ENTRIES);
    ...
    iterate.stop = function(result) { return new Result(true, result); };
  });
  ...
  if (!set$1 || !clear) {
    ...
    clear = function clearImmediate(id) { delete queue[id]; };
    // Node.js 0.8-
    if (classofRaw(process$1) == 'process') {
      defer = function(id) { process$1.nextTick(runner(id)); };
      // Sphere (JS game engine) Dispatch API
    } else if (Dispatch && Dispatch.now) {
      defer = function(id) { Dispatch.now(runner(id)); };
    ...
    } else if (global_1.addEventListener && typeof postMessage == 'function' &&
               !global_1.importScripts && !fails(post)) {
      defer = post;
      ...
      defer = function(id) {
        html.appendChild(
            documentCreateElement('script'))[ONREADYSTATECHANGE] = function() {
  ...
  var task = {set : set$1, clear : clear};
  ...
  var queueMicrotaskDescriptor =
      getOwnPropertyDescriptor$2(global_1, 'queueMicrotask');
  var queueMicrotask =
  ...
  if (!queueMicrotask) {
    ...
    // Node.js
    if (IS_NODE) {
      notify = function() { process$2.nextTick(flush); };
  ...
  var f$7 = function(C) { return new PromiseCapability(C); };

  var newPromiseCapability = {f : f$7};
  ...
  var DISPATCH_EVENT =
      !!(document$2 && document$2.createEvent && global_1.dispatchEvent);
  ...
  var FORCED$2 = isForced_1(PROMISE, function() {
    ...
    if (!GLOBAL_CORE_JS_PROMISE) {
      // V8 6.6 (Node 10 and Chrome 66) have a bug with resolving custom
      // thenables https://bugs.chromium.org/p/chromium/issues/detail?id=830565
    ...
    var FakePromise = function(
        exec) { exec(function() { /* empty */ }, function() { /* empty */ }); };
  ...
  var INCORRECT_ITERATION$1 =
      FORCED$2 || !checkCorrectnessOfIteration(function(iterable) {
  ...
  var isUnhandled = function(
      state) { return state.rejection !== HANDLED && !state.parent; };
  ...
  var bind = function(fn, promise, state, unwrap) {
    return function(value) { fn(promise, state, value, unwrap); };
  };
    ...
    try {
      ...
      if (then) {
        microtask(function() {
          ...
          try {
            then.call(value, bind(internalResolve, promise, wrapper, state),
  ...
  if (FORCED$2) {
    ...
    PromiseConstructor = function Promise(executor) {
      ...
      try {
        executor(bind(internalResolve, this, state),
    ...
    Internal.prototype = redefineAll(PromiseConstructor.prototype, {
      ...
      'catch' : function(
          onRejected) { return this.then(undefined, onRejected); }
    });
    ...
    if (typeof nativePromiseConstructor == 'function') {
      ...
      redefine(nativePromiseConstructor.prototype,
               'then', function then(onFulfilled, onRejected) {
                 var that = this;
      ...
      if (typeof $fetch$1 == 'function')
        _export({global : true, enumerable : true, forced : true}, {
          // eslint-disable-next-line no-unused-vars
          fetch : function fetch(input /* , init */) {
            return promiseResolve(PromiseConstructor,
  ...
  _export({target : PROMISE, stat : true, forced : FORCED$2}, {
    ...
    resolve : function resolve(x) { return promiseResolve(this, x); }
  });
  ...
  var USES_TO_LENGTH$5 =
      arrayMethodUsesToLength('splice', {ACCESSORS : true, 0 : 0, 1 : 2});
  ...
  },
          {
            splice : function splice(start, deleteCount /* , ...items */) {
              ...
              if (argumentsLength === 0) {
                ...
                actualDeleteCount =
                    min$5(max$3(toInteger(deleteCount), 0), len - actualStart);
              }
  ...
  // @@match logic
  fixRegexpWellKnownSymbolLogic(
      'match', 1, function(MATCH, nativeMatch, maybeCallNative) {
        return [
          ...
          function match(regexp) {
            ...
            return matcher !== undefined ? matcher.call(regexp, O)
    ...
    forced : !STRICT_METHOD$4 || !USES_TO_LENGTH$8
  },
          {
            reduce : function reduce(callbackfn /* , initialValue */) {
              return $reduce(this, callbackfn, arguments.length,
                             arguments.length > 1 ? arguments[1] : undefined);
            }
          });
  ...
  var FORCED$3 =
      descriptors &&
      isForced_1(
          'RegExp', (!CORRECT_NEW || UNSUPPORTED_Y$2 || fails(function() {
            re2[MATCH$2] = false;
            // RegExp constructor can alter flags and IsRegExp works correct
            // with @@match
            return NativeRegExp(re1) != re1 || NativeRegExp(re2) == re2 ||
  ...
  if (FORCED$3) {
    var RegExpWrapper = function RegExp(pattern, flags) {
      ...
      if (!thisIsRegExp && patternIsRegExp &&
          pattern.constructor === RegExpWrapper && flagsAreUndefined) {
        return pattern;
      }
  ...
  var NATIVE_ARRAY_BUFFER_VIEWS = arrayBufferNative && !!objectSetPrototypeOf &&
  ...
  var exportTypedArrayMethod = function(KEY, property, forced) {
    ...
    if (!TypedArrayPrototype[KEY] || forced) {
      redefine(TypedArrayPrototype, KEY,
               forced ? property
  ...
  var exportTypedArrayStaticMethod = function(KEY, property, forced) {
    ...
    if (objectSetPrototypeOf) {
      ...
      if (!TypedArray[KEY] || forced) {
        // V8 ~ Chrome 49-50 `%TypedArray%` methods are non-writable
        // non-configurable
        try {
          return redefine(TypedArray, KEY,
                          forced
                              ? property
  ...
  if (!NATIVE_ARRAY_BUFFER_VIEWS || typeof TypedArray != 'function' ||
      TypedArray === Function.prototype) {
    // eslint-disable-next-line no-shadow
    TypedArray =
        function TypedArray() { throw TypeError('Incorrect invocation'); };
  ...
  if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype ||
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS &&
      objectGetPrototypeOf(Uint8ClampedArrayPrototype) !==
          TypedArrayPrototype) {
  ...
  if (descriptors && !has(TypedArrayPrototype, TO_STRING_TAG$4)) {
    ...
    defineProperty$7(TypedArrayPrototype, TO_STRING_TAG$4, {
      get : function() {
  ...
  var typedArrayConstructorsRequireWrappers =
      !NATIVE_ARRAY_BUFFER_VIEWS$1 || !fails(function() { Int8Array$2(1); }) ||
      !fails(function() { new Int8Array$2(-1); }) ||
      !checkCorrectnessOfIteration(function(iterable) {
        ...
        // Safari (11+) bug - a reason why even Safari 13 should load a typed
        // array polyfill
  ...
  var ieee754 = {pack : pack, unpack : unpack};
  ...
  var packInt8 = function(number) { return [ number & 0xFF ]; };
  ...
  var packFloat32 = function(number) { return packIEEE754(number, 23, 4); };

  var packFloat64 = function(number) { return packIEEE754(number, 52, 8); };

  var addGetter = function(Constructor, key) {
    defineProperty$8(
        Constructor[PROTOTYPE$2], key,
        {get : function() { return getInternalState$4(this)[key]; }});
  };
  ...
  if (!arrayBufferNative) {
    ...
    $DataView = function DataView(buffer, byteOffset, byteLength) {
      ...
      setInternalState$7(
          this,
          {buffer : buffer, byteLength : byteLength, byteOffset : offset});
      if (!descriptors) {
        this.buffer = buffer;
        this.byteLength = byteLength;
    ...
    redefineAll($DataView[PROTOTYPE$2], {
      getInt8 : function getInt8(
          byteOffset) { return get$1(this, 1, byteOffset)[0] << 24 >> 24; },
      getUint8 : function getUint8(
          byteOffset) { return get$1(this, 1, byteOffset)[0]; },
      getInt16 : function getInt16(byteOffset /* , littleEndian */) {
        var bytes = get$1(this, 2, byteOffset,
                          arguments.length > 1 ? arguments[1] : undefined);
      ...
      getFloat64 : function getFloat64(byteOffset /* , littleEndian */) {
        return unpackIEEE754(
            get$1(this, 8, byteOffset,
                  arguments.length > 1 ? arguments[1] : undefined),
            52);
      },
      setInt8 : function setInt8(
          byteOffset, value) { set$2(this, 1, byteOffset, packInt8, value); },
      setUint8 : function setUint8(
          byteOffset, value) { set$2(this, 1, byteOffset, packInt8, value); },
      setInt16 : function setInt16(byteOffset, value /* , littleEndian */) {
        set$2(this, 2, byteOffset, packInt16, value,
      ...
      setInt32 : function setInt32(byteOffset, value /* , littleEndian */) {
        set$2(this, 4, byteOffset, packInt32, value,
              arguments.length > 2 ? arguments[2] : undefined);
      },
      ...
      setFloat32 : function setFloat32(byteOffset, value /* , littleEndian */) {
        set$2(this, 4, byteOffset, packFloat32, value,
              arguments.length > 2 ? arguments[2] : undefined);
      },
      setFloat64 : function setFloat64(byteOffset, value /* , littleEndian */) {
        set$2(this, 8, byteOffset, packFloat64, value,
              arguments.length > 2 ? arguments[2] : undefined);
      }
    });
  } else {
    if (!fails(function() { NativeArrayBuffer(1); }) || !fails(function() {
      ...
      for (var keys$2 = getOwnPropertyNames$1(NativeArrayBuffer), j = 0, key;
           keys$2.length > j;) {
        if (!((key = keys$2[j++]) in $ArrayBuffer)) {
          createNonEnumerableProperty($ArrayBuffer, key,
    ...
    if (objectSetPrototypeOf &&
        objectGetPrototypeOf($DataViewPrototype) !== ObjectPrototype$3) {
    ...
    if (testView.getInt8(0) || !testView.getInt8(1))
      redefineAll($DataViewPrototype, {
        setInt8 : function setInt8(
            byteOffset,
            value) { nativeSetInt8.call(this, byteOffset, value << 24 >> 24); },
        setUint8 : function setUint8(
            byteOffset,
            value) { nativeSetInt8.call(this, byteOffset, value << 24 >> 24); }
      },
  ...
  var typedArrayConstructor = createCommonjsModule(function(module) {
    ...
    var addGetter = function(it, key) {
      nativeDefineProperty(
          it, key, {get : function() { return getInternalState(this)[key]; }});
    };
    ...
    var wrappedDefineProperty = function defineProperty(target, key,
                                                        descriptor) {
      if (isTypedArrayIndex(target, key = toPrimitive(key, true)) &&
          isObject(descriptor) && has(descriptor, 'value') &&
          !has(descriptor, 'get') &&
          !has(descriptor, 'set')
      ...
      module.exports = function(TYPE, wrapper, CLAMPED) {
        ...
        var addElement = function(that, index) {
          nativeDefineProperty(that, index, {
            get : function() { return getter(this, index); },
        ...
        if (!NATIVE_ARRAY_BUFFER_VIEWS) {
          TypedArrayConstructor =
              wrapper(function(that, data, offset, $length) {
          ...
          TypedArrayConstructor = wrapper(function(dummy, data,
                                                   typedArrayOffset, $length) {
              ...
              if (isArrayBuffer(data))
                return $length !== undefined
                           ? new NativeTypedArrayConstructor(
                                 data, toOffset(typedArrayOffset, BYTES),
                                 $length)
          ...
          if (objectSetPrototypeOf)
            objectSetPrototypeOf(TypedArrayConstructor, TypedArray);
          forEach(
              getOwnPropertyNames(NativeTypedArrayConstructor), function(key) {
                if (!(key in TypedArrayConstructor)) {
                  createNonEnumerableProperty(TypedArrayConstructor, key,
        ...
        if (TypedArrayConstructorPrototype.constructor !==
            TypedArrayConstructor) {
          createNonEnumerableProperty(TypedArrayConstructorPrototype,
                                      'constructor', TypedArrayConstructor);
        }

        if (TYPED_ARRAY_TAG) {
          createNonEnumerableProperty(TypedArrayConstructorPrototype,
                                      TYPED_ARRAY_TAG, CONSTRUCTOR_NAME);
        }
  ...
  typedArrayConstructor('Uint16', function(init) {
    return function Uint16Array(
        data, byteOffset,
        length) { return init(this, data, byteOffset, length); };
  });
  ...
  var arrayCopyWithin =
      [].copyWithin || function copyWithin(target /* = 0 */,
        ...
        var count =
            min$6((end === undefined ? len : toAbsoluteIndex(end, len)) - from,
                  len - to);
        var inc = 1;
  ...
  exportTypedArrayMethod$1(
      'copyWithin', function copyWithin(target, start /* , end */) {
        return arrayCopyWithin.call(aTypedArray$1(this), target, start,
  ...
  exportTypedArrayMethod$2('every', function every(callbackfn /* , thisArg */) {
    return $every(aTypedArray$2(this), callbackfn,
                  arguments.length > 1 ? arguments[1] : undefined);
  });
  ...
  exportTypedArrayMethod$4(
      'filter', function filter(callbackfn /* , thisArg */) {
        var list = $filter$1(aTypedArray$4(this), callbackfn,
                             arguments.length > 1 ? arguments[1] : undefined);
  ...
  exportTypedArrayMethod$5('find', function find(predicate /* , thisArg */) {
    return $find(aTypedArray$5(this), predicate,
                 arguments.length > 1 ? arguments[1] : undefined);
  });
  ...
  exportTypedArrayMethod$6(
      'findIndex', function findIndex(predicate /* , thisArg */) {
        return $findIndex(aTypedArray$6(this), predicate,
                          arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  exportTypedArrayMethod$7(
      'forEach', function forEach(callbackfn /* , thisArg */) {
        $forEach$2(aTypedArray$7(this), callbackfn,
                   arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  exportTypedArrayMethod$8(
      'includes', function includes(searchElement /* , fromIndex */) {
        return $includes$1(aTypedArray$8(this), searchElement,
                           arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  exportTypedArrayMethod$9(
      'indexOf', function indexOf(searchElement /* , fromIndex */) {
        return $indexOf$1(aTypedArray$9(this), searchElement,
                          arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  var typedArrayValues =
      function values() { return arrayValues.call(aTypedArray$a(this)); };

  // `%TypedArray%.prototype.entries` method
  // https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.entries
  exportTypedArrayMethod$a(
      'entries',
      function entries() { return arrayEntries.call(aTypedArray$a(this)); });
  // `%TypedArray%.prototype.keys` method
  // https://tc39.github.io/ecma262/#sec-%typedarray%.prototype.keys
  exportTypedArrayMethod$a(
      'keys', function keys() { return arrayKeys.call(aTypedArray$a(this)); });
  ...
  exportTypedArrayMethod$b(
      'join',
      function join(
          separator) { return $join.apply(aTypedArray$b(this), arguments); });
  ...
  exportTypedArrayMethod$d('map', function map(mapfn /* , thisArg */) {
    return $map$1(aTypedArray$d(this), mapfn,
                  arguments.length > 1 ? arguments[1] : undefined,
                  function(O, length) {
                    return new (aTypedArrayConstructor$3(
                        speciesConstructor(O, O.constructor)))(length);
                  });
  });
  ...
  exportTypedArrayMethod$e(
      'reduce', function reduce(callbackfn /* , initialValue */) {
        return $reduce$1(aTypedArray$e(this), callbackfn, arguments.length,
                         arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  exportTypedArrayMethod$f(
      'reduceRight', function reduceRight(callbackfn /* , initialValue */) {
        return $reduceRight(aTypedArray$f(this), callbackfn, arguments.length,
                            arguments.length > 1 ? arguments[1] : undefined);
      });
  ...
  exportTypedArrayMethod$j('some', function some(callbackfn /* , thisArg */) {
    return $some(aTypedArray$j(this), callbackfn,
                 arguments.length > 1 ? arguments[1] : undefined);
  });
  ...
  exportTypedArrayMethod$k(
      'sort',
      function sort(
          comparefn) { return $sort.call(aTypedArray$k(this), comparefn); });
  ...
  exportTypedArrayMethod$l('subarray', function subarray(begin, end) {
    ...
    return new (speciesConstructor(O, O.constructor))(
        O.buffer, O.byteOffset + beginIndex * O.BYTES_PER_ELEMENT,
  ...
  var TO_LOCALE_STRING_BUG =
      !!Int8Array$3 &&
      fails(function() { $toLocaleString.call(new Int8Array$3(1)); });
  ...
  exportTypedArrayMethod$m('toLocaleString', function toLocaleString() {
    return $toLocaleString.apply(TO_LOCALE_STRING_BUG
  ...
  if (fails(function() { arrayToString.call({}); })) {
    arrayToString = function toString() { return arrayJoin.call(this); };
  }
  ...
  var stringify_1 = createCommonjsModule(function(module, exports) {
    /*
     ...
     ISC license:
     https://github.com/isaacs/json-stringify-safe/blob/master/LICENSE
    */
    ...
    function stringifyError(value) {
      var err = {
        // These properties are implemented as magical getters and don't show up
        // in for in
        stack : value.stack,
  ...
  } // Despite all stars in the sky saying that Edge supports old draft syntax,
    // aka 'never', 'always', 'origin' and 'default
  ...
  function objectMerge(obj1, obj2) {
    ...
    each(obj2, function(key, value) { obj1[key] = value; });
    return obj1;
  }
  /**
   ...
   * supported because it's not relevant for other "platforms". See related
   * issue: https://github.com/getsentry/react-native-sentry/issues/57
   */
  ...
  function joinRegExp(patterns) {
    ...
    // Be mad.
    var sources = [], i = 0, len = patterns.length, pattern;
  ...
  // intentionally using regex and not <a/> href parsing trick because React
  // Native and other environments where DOM might not be available
  ...
  function uuid4() {
    ...
    if (!isUndefined(crypto) && crypto.getRandomValues) {
      ...
      arr[3] = arr[3] & 0xfff |
               0x4000; // set 2 most significant bits of byte 9 to '10'
      ...
      return pad(arr[0]) + pad(arr[1]) + pad(arr[2]) + pad(arr[3]) +
             pad(arr[4]) + pad(arr[5]) + pad(arr[6]) + pad(arr[7]);
    } else {
  ...
  /**
   * Given a child DOM element, returns a query-selector statement describing
   * that and its ancestors e.g. [HTMLElement] => body > div >
   * input#foo.btn[name=baz]
   * @param elem
   * @returns {string}
   */
  ...
  function htmlTreeAsString(elem) {
    ...
    var MAX_TRAVERSE_HEIGHT = 5, MAX_OUTPUT_LEN = 80, out = [], height = 0,
        len = 0, separator = ' > ', sepLength = separator.length, nextStr;
  ...
  function isSameException(ex1, ex2) {
    ...
    if (ex1.type !== ex2.type || ex1.value !== ex2.value)
      return false; // in case both stacktraces are undefined, we can't decide
                    // so default to false
  ...
  function isSameStacktrace(stack1, stack2) {
    ...
    if (frames1 === undefined || frames2 === undefined)
      return false; // Exit early if frame count differs

    if (frames1.length !== frames2.length)
      return false; // Iterate through every frame; bail out if anything differs
    ...
    for (var i = 0; i < frames1.length; i++) {
      a = frames1[i];
      b = frames2[i];
      if (a.filename !== b.filename || a.lineno !== b.lineno ||
          a.colno !== b.colno || a['function'] !== b['function'])
        return false;
    }
  ...
  var MAX_SERIALIZE_EXCEPTION_DEPTH =
      3; // 50kB, as 100kB is max payload size, so half sounds reasonable
  ...
  function serializeObject(value, depth) {
    ...
    if (isPlainObject(value)) {
      ...
      return value.map(function(
          val) { return serializeObject(val, depth - 1); });
    }
  ...
  function serializeException(ex, depth, maxSize) {
    ...
    maxSize =
        typeof depth !== 'number' ? MAX_SERIALIZE_EXCEPTION_SIZE : maxSize;
  ...
  function sanitize(input, sanitizeKeys) {
    if (!isArray$1(sanitizeKeys) ||
        isArray$1(sanitizeKeys) && sanitizeKeys.length === 0)
      return input;
  ...
  */
  ...
  var TraceKit = {
    ...
    debug : false
  }; // This is to be defensive in environments where window does not exist (see
     // https://github.com/getsentry/raven-js/pull/785)

  var _window$1 = typeof window !== 'undefined'
                      ? window
                      : typeof commonjsGlobal !== 'undefined'
                            ? commonjsGlobal
  ...
  TraceKit.report = function reportModuleWrapper() {
    var handlers = [], lastArgs = null, lastException = null,
    ...
    function traceKitWindowOnError(msg, url, lineNo, colNo, ex) {
      ...
      var exception =
          utils.isErrorEvent(ex)
              ? ex.error
              : ex; // If 'msg' is ErrorEvent, get real message from inside
      ...
      if (lastExceptionStack) {
        ...
        var location = {url : url, line : lineNo, column : colNo};
        var name = undefined;
        var groups;
    ...
    function report(ex, rethrow) {
      ...
      lastException = ex;
      lastArgs =
          args; // If the stack trace is incomplete, wait for 2 seconds for
      ...
      if (rethrow !== false) {
        throw ex; // re-throw to propagate to the top level (and cause
                  // window.onerror)
      }
    }
   ...
   *
   * Syntax:
   *   s = TraceKit.computeStackTrace(exception) // consider using
   * TraceKit.report instead (see below) Returns: s.name              -
   * exception name s.message           - exception message s.stack[i].url -
   * JavaScript or HTML file URL s.stack[i].func     - function name, or empty
   * for anonymous functions (if guessing did not work) s.stack[i].args     -
   * arguments passed to the function, if known s.stack[i].line     - line
   * number, if known s.stack[i].column   - column number, if known
   *
   * Supports:
  ...
  TraceKit.computeStackTrace = function computeStackTraceWrapper() {
    ...
    // ex.name = ReferenceError
    // ex.opera#sourceloc = 11  (pretty much useless, duplicates the info in
    // ex.message) ex.stacktrace = n/a; see 'opera:config#UserPrefs|Exceptions
    // Have Stacktrace'
    ...
    function computeStackTraceFromStackProp(ex) {
      ...
      // which is `blob:http://url/path/with-some-uuid`, is matched by
      // `blob.*?:\/` as well
      ...
      for (var i = 0, j = lines.length; i < j; ++i) {
        if (parts = chrome.exec(lines[i])) {
          var isNative =
              parts[2] && parts[2].indexOf('native') === 0; // start of line

          var isEval =
              parts[2] && parts[2].indexOf('eval') === 0; // start of line
          ...
          if (isEval && (submatch = geckoEval.exec(parts[3]))) {
            ...
            // Also note, Firefox's column number is 0-based and everything else
            // expects 1-based, so adding 1 NOTE: this hack doesn't work if
            // top-most frame is eval
        ...
        if (element.url && element.url.substr(0, 5) === 'blob:') {
          ...
          // memory - it's not making a network request.  This will generate a
          // warning in the browser console, but there has already been an error
          // so that's not that much of an issue.
          var xhr = new XMLHttpRequest();
          xhr.open('GET', element.url, false);
          xhr.send(
              null); // If we failed to download the source, skip this patch

          if (xhr.status === 200) {
            var source =
                xhr.responseText ||
                ''; // We trim the source down to the last 300 characters as
                    // sourceMappingURL is always at the end of the file.
            // Why 300? To be in line with:
            // https://github.com/getsentry/sentry/blob/4af29e8f2350e20c28a6933354e4f42437b4ba42/src/sentry/lang/javascript/processor.py#L164-L175

            source = source.slice(-300); // Now we dig out the source map URL

            var sourceMaps = source.match(
                /\/\/# sourceMappingURL=(.*)$/); // If we don't find a source
                                                 // map comment or we find more
                                                 // than one, continue on to the
                                                 // next element.

            if (sourceMaps) {
              var sourceMapAddress =
                  sourceMaps[1]; // Now we check to see if it's a relative URL.
              // If it is, convert it to an absolute one.

              if (sourceMapAddress.charAt(0) === '~') {
                sourceMapAddress =
                    getLocationOrigin() + sourceMapAddress.slice(1);
              } // Now we strip the '.map' off of the end of the URL and update
                // the
    ...
    function computeStackTraceByWalkingCallerChain(ex, depth) {
      var functionName =
          ...
          stack = [], funcs = {}, recursion = false, parts, item;

      for (var curr = computeStackTraceByWalkingCallerChain.caller;
           curr && !recursion; curr = curr.caller) {
        ...
        item =
            {url : null, func : UNKNOWN_FUNCTION, line : null, column : null};
      ...
      augmentStackTraceWithInitialElement(result, ex.sourceURL || ex.fileName,
  ...
  var wrapMethod = function wrapMethod(console, level, callback) {
    ...
    console[level] = function() {
      ...
      if (originalConsoleLevel) {
        ...
        // See:
        // https://stackoverflow.com/questions/5472938/does-ie9-support-console-log-and-is-it-a-real-function#answer-5473193
  ...
  var console$1 = {wrapMethod : wrapMethod};
  ...
  var _window$2 = typeof window !== 'undefined'
                      ? window
                      : typeof commonjsGlobal !== 'undefined'
                            ? commonjsGlobal
                            : typeof self !== 'undefined' ? self : {};
  ...
  function Raven() {
    this._hasJSON =
        !!((typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) ===
               'object' &&
           JSON.stringify); // Raven can run in contexts where there's no
    ...
    this._globalContext = {};
    this._globalOptions = {
      // SENTRY_RELEASE can be injected by
    ...
    this._fetchDefaults = {
      method : 'POST',
      // Despite all stars in the sky saying that Edge supports old draft
      // syntax, aka 'never', 'always', 'origin' and 'default
      // https://caniuse.com/#feat=referrer-policy
      // It doesn't. And it throw exception instead of ignoring this
      // parameter... REF: https://github.com/getsentry/raven-js/issues/1233
      referrerPolicy : supportsReferrerPolicy$1() ? 'origin' : ''
    };
    this._ignoreOnError = 0;
    this._isRavenInstalled = false;
    this._originalErrorStackTraceLimit =
        Error.stackTraceLimit; // capture references to window.console *and* all
                               // its methods first
  ...
  Raven.prototype = {
    ...
    config : function config(dsn, options) {
      ...
      self.setDSN(dsn); // "Script error." is hard coded into browsers for
                        // errors that it can't read.
      // this is the result of a script being pulled in from an external domain
      // and CORS.

      globalOptions.ignoreErrors.push(/^Script error\.?$/);
      globalOptions.ignoreErrors.push(
          /^Javascript error: Script error\.? on line 0$/); // join regexp rules
                                                            // into one big rule
      ...
      globalOptions.whitelistUrls =
          globalOptions.whitelistUrls.length
              ? joinRegExp$1(globalOptions.whitelistUrls)
              : false;
      globalOptions.includePaths = joinRegExp$1(globalOptions.includePaths);
      globalOptions.maxBreadcrumbs =
          Math.max(0, Math.min(globalOptions.maxBreadcrumbs || 100,
                               100)); // default and hard limit is 100
      ...
      if ({}.toString.call(autoBreadcrumbs) === '[object Object]') {
        autoBreadcrumbs =
            objectMerge$1(autoBreadcrumbDefaults, autoBreadcrumbs);
      ...
      tracekit.collectWindowErrors =
          !!globalOptions.collectWindowErrors; // return for chaining
    ...
    install : function install() {
      ...
      if (self.isSetup() && !self._isRavenInstalled) {
        ...
        if (self._globalOptions.instrument &&
            self._globalOptions.instrument.tryCatch) {
          self._instrumentTryCatch();
        }

        if (self._globalOptions.autoBreadcrumbs)
          self._instrumentBreadcrumbs(); // Install all of the plugins
    ...
    setDSN : function setDSN(dsn) {
      var self = this, uri = self._parseDSN(dsn),
      ...
      self._globalEndpoint =
          self._globalServer + '/' + path + 'api/' + self._globalProject +
          '/store/'; // Reset backoff state since we may be pointing at a
      // new project/server
     ...
     *
     * @param {object} options A specific set of options for this context
     *     [optional]
     * @param {function} func The callback to be immediately executed within the
     *     context
     * @param {array} args An array of arguments to be called with the callback
     *     [optional]
     */
     ...
     * @param {function} _before A function to call before the try/catch wrapper
     *     [optional, private]
    ...
    wrap : function wrap(options, func, _before) {
      ...
      try {
        ...
        // Bail on wrapping and return the function as-is (defers to
        // window.onerror).
        return func;
      }
      ...
      function wrapped() {
        ...
        try {
          ...
          // NOTE: If you are a Sentry user, and you are seeing this stack
          // frame, it
          //       means Raven caught an error invoking your application code.
          //       This is expected behavior and NOT indicative of a bug with
          //       Raven.js.
      ...
      func.__raven_wrapper__ =
          wrapped; // Signal that this function has been wrapped/filled already
    ...
    _promiseRejectionHandler : function _promiseRejectionHandler(event) {
      this._logDebug('debug',
                     'Raven caught unhandled promise rejection:', event);
    ...
    _attachPromiseRejectionHandler : function _attachPromiseRejectionHandler() {
      ...
      _window$2.addEventListener &&
          _window$2.addEventListener('unhandledrejection',
    ...
    _detachPromiseRejectionHandler : function _detachPromiseRejectionHandler() {
      _window$2.removeEventListener &&
          _window$2.removeEventListener('unhandledrejection',
                                        this._promiseRejectionHandler);
      return this;
    },
     ...
     * @param {object} options A specific set of options for this error
     *     [optional]
     * @return {Raven}
     */
    captureException : function captureException(ex, options) {
      ...
      if (isErrorEvent$1(ex) && ex.error) {
        // If it is an ErrorEvent with `error` property, extract it to get
        // actual Error
        ex = ex.error;
      } else if (isDOMError$1(ex) || isDOMException$1(ex)) {
        // If it is a DOMError or DOMException (which are legacy APIs, but still
        // supported in some browsers) then we just extract the name and
        // message, as they don't provide anything else
        // https://developer.mozilla.org/en-US/docs/Web/API/DOMError
        // https://developer.mozilla.org/en-US/docs/Web/API/DOMException
        var name = ex.name || (isDOMError$1(ex) ? 'DOMError' : 'DOMException');
        var message = ex.message ? name + ': ' + ex.message : name;
        return this.captureMessage(
            message, objectMerge$1(options, {
              // neither DOMError or DOMException provide stack trace and we
              // most likely wont get it this way as well
        ...
        // which is much better than creating new group when any key/value
        // change
        ...
        return this.captureMessage(ex, objectMerge$1(options, {
                                     stacktrace : true,
                                     // if we fall back to captureMessage,
                                     // default to attempting a new trace
                                     trimHeadFrames : options.trimHeadFrames + 1
                                   }));
      } // Store the raw exception object for potential debugging and
        // introspection

      this._lastCapturedException =
          ex; // TraceKit.report will re-raise any exception passed to it,
    ...
    _getCaptureExceptionOptionsFromPlainObject :
        function _getCaptureExceptionOptionsFromPlainObject(currentOptions,
                                                            ex) {
          var exKeys = Object.keys(ex).sort();
          var options = objectMerge$1(currentOptions, {
            message : 'Non-Error exception captured with keys: ' +
                          serializeKeysForMessage$1(exKeys),
     ...
     * @param {object} options A specific set of options for this message
     *     [optional]
     * @return {Raven}
     */
    captureMessage : function captureMessage(msg, options) {
      // config() automagically converts ignoreErrors from a list to a RegExp so
      // we need to test for an early call; we'll error on the side of logging
      // anything called before configuration since it's probably something you
      // should see:
      ...
      var data = objectMerge$1({message : msg}, options);
      var ex; // Generate a "synthetic" stack trace from this point.
      // NOTE: If you are a Sentry user, and you are seeing this stack frame, it
      // is NOT indicative
      //       of a bug with Raven.js. Sentry generates synthetic traces either
      //       by configuration, or if it catches a thrown object without a
      //       "stack" property.
      ...
      ex.name = null;
      var stack = tracekit.computeStackTrace(
          ex); // stack[0] is `throw new Error(msg)` call itself, we are
               // interested in the frame that was just before that, stack[1]

      var initialCall =
          isArray$2(stack.stack) &&
          stack.stack[1]; // if stack[1] is `Raven.captureException`, it means
                          // that someone passed a string to it and we
                          // redirected that call
      // to be handled by `captureMessage`, thus `initialCall` is the 3rd one,
      // not 2nd initialCall => captureException(string) =>
      ...
      if (this._globalOptions.stacktrace || options.stacktrace ||
          data.message === '') {
        // fingerprint on msg, not stack trace (legacy behavior, could be
        // revisited)
        data.fingerprint = data.fingerprint == null ? msg : data.fingerprint;
        options =
            objectMerge$1({trimHeadFrames : 0},
                          options); // Since we know this is a synthetic trace,
                                    // the top frame (this function call)
        // MUST be from Raven.js, so mark it for trimming
        // We add to the trim counter so that callers can choose to trim extra
        // frames, such as utility functions.
      ...
      if (data.fingerprint) {
        data.fingerprint = isArray$2(data.fingerprint) ? data.fingerprint
                                                       : [ data.fingerprint ];
      } // Fire away!
    ...
    captureBreadcrumb : function captureBreadcrumb(obj) {
      var crumb = objectMerge$1({timestamp : now() / 1000}, obj);
     ...
     *
     * @param {string} release Typically something like a git SHA to identify
     *     version
     * @return {Raven}
     */
     ...
     */
    lastException :
        function lastException() { return this._lastCapturedException; },
     ...
     * @return {string}
     */
    lastEventId : function lastEventId() { return this._lastEventId; },
    ...
    showReportDialog : function showReportDialog(options) {
      ...
      for (var key in options) {
        if (key === 'user') {
          ...
          if (user.name)
            encodedOptions.push('name=' + encode(user.name));
          if (user.email)
            encodedOptions.push('email=' + encode(user.email));
        } else {
    ...
    _triggerEvent : function _triggerEvent(eventType, options) {
      // NOTE: `event` is a native browser thing, so let's avoid conflicting
      // wiht it
      var evt, key;
    ...
    _breadcrumbEventHandler : function _breadcrumbEventHandler(evtName) {
      ...
      return function(evt) {
        ...
        self._keypressTimeout = null; // It's possible this handler might
                                      // trigger multiple times for the same
        // event (e.g. event propagation through node ancestors). Ignore if
        // we've already captured the event.

        if (self._lastCapturedEvent === evt)
          return;
        self._lastCapturedEvent = evt; // try/catch both:
        // - accessing evt.target (see getsentry/raven-js#838, #768)
        // - `htmlTreeAsString` because it's complex, and just accessing the DOM
        // incorrectly
    ...
    _keypressEventHandler : function _keypressEventHandler() {
      ...
      return function(evt) {
        ...
        try {
          ...
          // just accessing event properties can throw an exception in some rare
          // circumstances see: https://github.com/getsentry/raven-js/issues/838
          return;
        }

        var tagName = target && target.tagName; // only consider keypress events
                                                // on actual input elements
        // this will disregard keypresses targeting body (e.g. tabbing
        // through elements, hotkeys, etc)

        if (!tagName || tagName !== 'INPUT' && tagName !== 'TEXTAREA' &&
                            !target.isContentEditable)
          return; // record first keypress in a series, but ignore subsequent
        ...
        self._keypressTimeout =
            setTimeout(function() { self._keypressTimeout = null; },
                       debounceDuration);
      };
    },
    ...
    _captureUrlChange : function _captureUrlChange(from, to) {
      ...
      var parsedFrom =
          parseUrl$1(from); // because onpopstate only tells you the "new" (to)
                            // value of location.href, and
      // not the previous (from) value, we need to track the value of the
      // current URL state ourselves

      this._lastHref = to; // Use only the path component of the URL if the URL
                           // matches the current
      ...
      this.captureBreadcrumb(
          {category : 'navigation', data : {to : to, from : from}});
    },
            ...
            args[0] = self.wrap({
              mechanism : {
                ...
                data : {function : orig.name || '<anonymous>'}
                                ...
                                originalCallback);
          } // IE < 9 doesn't support .call/.apply on setInterval/setTimeout,
            // but it
          // also supports only two arguments and doesn't care what this is, so
          // we can just call the original function directly.
        ...
        if (proto && proto.hasOwnProperty &&
          ...
          fill$1(proto, 'addEventListener', function(orig) {
            return function(evtName, fn, capture, secure) {
              ...
              } // can sometimes get 'Permission denied to access property
                // "handle Event'
              // More breadcrumb DOM capture ... done here and not in
              // `_instrumentBreadcrumbs` so that we don't have more than one
              // wrapper function

              var before, clickHandler, keypressHandler;

              if (autoBreadcrumbs && autoBreadcrumbs.dom &&
                  (global === 'EventTarget' || global === 'Node')) {
                // NOTE: generating multiple handlers per addEventListener
                // invocation, should
                //       revisit and verify we can just use one (almost
                //       certainly)
                clickHandler = self._breadcrumbEventHandler('click');
                keypressHandler = self._keypressEventHandler();

                before = function before(evt) {
                  // need to intercept every DOM event in `before` argument, in
                  // case that same wrapped method is re-used for different
                  // events (e.g. mousemove THEN click) see #724
                  if (!evt)
                    return;
                  var eventType;
                  ...
                  try {
                    ...
                    // just accessing event properties can throw an exception in
                    // some rare circumstances see:
                    // https://github.com/getsentry/raven-js/issues/838
                    return;
                  }
          ...
          fill$1(proto, 'removeEventListener', function(orig) {
            return function(evt, fn, capture, secure) {
              ...
              } catch (e) { // ignore, accessing __raven_wrapper__ will throw in
                            // some Selenium environments
              }
    ...
    _instrumentBreadcrumbs : function _instrumentBreadcrumbs() {
      ...
      if (autoBreadcrumbs.xhr && 'XMLHttpRequest' in _window$2) {
        var xhrproto =
            _window$2.XMLHttpRequest && _window$2.XMLHttpRequest.prototype;
          ...
          return function() {
            ...
            function onreadystatechangeHandler() {
              if (xhr.__raven_xhr && xhr.readyState === 4) {
                ...
                self.captureBreadcrumb(
                    {type : 'http', category : 'xhr', data : xhr.__raven_xhr});
              }
            }
            ...
            if ('onreadystatechange' in xhr &&
                isFunction$1(xhr.onreadystatechange)) {
              fill$1(
              ...
              // if onreadystatechange wasn't actually set by the page on this
              // xhr, we are free to set our own and capture the breadcrumb
        ...
        fill$1(_window$2, 'fetch', function(origFetch) {
          return function() {
            ...
            if (typeof fetchInput === 'string') {
              url = fetchInput;
            } else if ('Request' in _window$2 && fetchInput instanceof
                                                     _window$2.Request) {
              url = fetchInput.url;
              ...
              url = '' + fetchInput;
            } // if Sentry key appears in URL, don't capture, as it's our own
              // request
            ...
            var fetchData = {method : method, url : url, status_code : null};
            return origFetch.apply(this, args).then(function(response) {
              fetchData.status_code = response.status;
              self.captureBreadcrumb(
                  {type : 'http', category : 'fetch', data : fetchData});
              return response;
            })['catch'](function(err) {
      ...
      } // Capture breadcrumbs from any click that is unhandled / bubbled up all
        // the way
      ...
      if (autoBreadcrumbs.dom && this._hasDocument) {
        if (_document.addEventListener) {
          _document.addEventListener(
              'click', self._breadcrumbEventHandler('click'), false);

          _document.addEventListener('keypress', self._keypressEventHandler(),
                                     false);
        } else if (_document.attachEvent) {
          // IE8 Compatibility
          _document.attachEvent('onclick',
                                self._breadcrumbEventHandler('click'));

          _document.attachEvent('onkeypress', self._keypressEventHandler());
        }
      } // record navigation (URL) changes
      // NOTE: in Chrome App environment, touching history.pushState, *even
      // inside
      //       a try/catch block*, will cause Chrome to output an error to
      //       console.error
      // borrowed from: https://github.com/angular/angular.js/pull/13945/files

      var chrome = _window$2.chrome;
      var isChromePackagedApp = chrome && chrome.app && chrome.app.runtime;
      var hasPushAndReplaceState = !isChromePackagedApp && _window$2.history &&
      ...
      if (autoBreadcrumbs.location && hasPushAndReplaceState) {
        ...
        var historyReplacementFunction = function historyReplacementFunction(
            origHistFunction) {
          ...
          /* state, title, url */
          {
            var url = arguments.length > 2
                          ? arguments[2]
                          : undefined; // url argument is optional
        ...
        fill$1(_window$2.history, 'pushState', historyReplacementFunction,
               wrappedBuiltIns);
        fill$1(_window$2.history, 'replaceState', historyReplacementFunction,
               wrappedBuiltIns);
      }
      ...
      if (autoBreadcrumbs.console && 'console' in _window$2 && console.log) {
        ...
        var consoleMethodCallback = function consoleMethodCallback(msg, data) {
          self.captureBreadcrumb(
              {message : msg, level : data.level, category : 'console'});
        };
    ...
    _handleOnErrorStackInfo : function _handleOnErrorStackInfo(stackInfo,
                                                               options) {
      options = options || {};
    ...
    _handleStackInfo : function _handleStackInfo(stackInfo, options) {
      ...
      this._triggerEvent('handle', {stackInfo : stackInfo, options : options});

      this._processException(stackInfo.name, stackInfo.message, stackInfo.url,
                             stackInfo.lineno, frames, options);
    },
    _prepareFrames : function _prepareFrames(stackInfo, options) {
      ...
      if (stackInfo.stack && stackInfo.stack.length) {
        ...
        if (options && options.trimHeadFrames) {
          for (var j = 0; j < options.trimHeadFrames && j < frames.length;
               j++) {
    ...
    _normalizeFrame : function _normalizeFrame(frame, stackInfoUrl) {
      ...
      //
      // We should probably somehow let a user know that they should fix their
      // code

      if (!frame.url) {
        normalized.filename =
            stackInfoUrl; // fallback to whole stacks url from onerror handler
      }

      normalized
          .in_app = !( // determine if an exception came from outside of our app
          // first we check the global includePaths list.
          !!this._globalOptions.includePaths.test &&
              !this._globalOptions.includePaths.test(
                  normalized.filename) || // Now we check for fun, if the
                                          // function name is Raven or TraceKit
          /(Raven|TraceKit)\./.test(
              normalized['function']) || // finally, we do a last ditch effort
                                         // and check for raven.min.js
          /raven\.(min\.)?js$/.test(normalized.filename));
      return normalized;
    },
    _processException : function _processException(type, message, fileurl,
                                                   lineno, frames, options) {
      ...
      if (frames && frames.length) {
        fileurl = frames[0].filename ||
                  fileurl; // Sentry expects frames oldest to newest
        ...
        stacktrace = {
          frames : [ {filename : fileurl, lineno : lineno, in_app : true} ]
        };
      }
      ...
      var data = objectMerge$1({
        ...
        exception : {
          values : [ {type : type, value : message, stacktrace : stacktrace} ]
        },
        transaction : fileurl
      },
                               options);
      ...
      // We do this, as requiring user to pass `{exception:{mechanism:{ ... }}}`
      // would be too much
      ...
      data.exception.mechanism =
          objectMerge$1({type : 'generic', handled : true},
    ...
    _trimPacket : function _trimPacket(data) {
      ...
      if (request) {
        if (request.url) {
          request.url =
              truncate$1(request.url, this._globalOptions.maxUrlLength);
        }

        if (request.Referer) {
          request.Referer =
              truncate$1(request.Referer, this._globalOptions.maxUrlLength);
        }
      }
    ...
    _trimBreadcrumbs : function _trimBreadcrumbs(breadcrumbs) {
      ...
      var urlProps = [ 'to', 'from', 'url' ], urlProp, crumb, data;

      for (var i = 0; i < breadcrumbs.values.length; ++i) {
        crumb = breadcrumbs.values[i];
        if (!crumb.hasOwnProperty('data') || !isObject$2(crumb.data) ||
        ...
        for (var j = 0; j < urlProps.length; ++j) {
          ...
          if (data.hasOwnProperty(urlProp) && data[urlProp]) {
            data[urlProp] =
                truncate$1(data[urlProp], this._globalOptions.maxUrlLength);
          }
        }
    ...
    _getHttpData : function _getHttpData() {
      ...
      if (this._hasNavigator && _navigator.userAgent) {
        httpData.headers = {'User-Agent' : _navigator.userAgent};
      } // Check in `window` instead of `document`, as we may be in
    ...
    _isRepeatData : function _isRepeatData(current) {
      ...
      if (
          ...
          current.transaction !==
              last.transaction // defined for captureException/onerror
      )
      ...
      if (current.stacktrace || last.stacktrace) {
        ...
        return Boolean(current.fingerprint && last.fingerprint) &&
               JSON.stringify(current.fingerprint) ===
                   JSON.stringify(last.fingerprint);
      }
    ...
    _setBackoffState : function _setBackoffState(request) {
      ...
      var status =
          request.status; // 400 - project_id doesn't exist or some other fatal
    ...
    _send : function _send(data) {
      ...
      } // HACK: delete `trimHeadFrames` to prevent from appearing in outbound
        // payload

      if (data.trimHeadFrames)
        delete data.trimHeadFrames;
      data = objectMerge$1(
          baseData, data); // Merge in the tags and extra separately since
                           // objectMerge doesn't handle a deep merge

      data.tags =
          objectMerge$1(objectMerge$1({}, this._globalContext.tags), data.tags);
      data.extra = objectMerge$1(
          objectMerge$1({}, this._globalContext.extra),
          data.extra); // Send along our own collected metadata with extra
      ...
      if (this._breadcrumbs && this._breadcrumbs.length > 0) {
        ...
        data.breadcrumbs = {values : [].slice.call(this._breadcrumbs, 0)};
      }
      ...
      if (globalOptions.environment)
        data.environment =
            globalOptions.environment; // Include the release if it's defined in
                                       // globalOptions

      if (globalOptions.release)
        data.release = globalOptions.release; // Include server_name if it's
                                              // defined in globalOptions

      if (globalOptions.serverName)
        data.server_name = globalOptions.serverName;
      data = this._sanitizeData(
          data); // Cleanup empty properties before sending them to the server

      Object.keys(data).forEach(function(key) {
        if (data[key] == null || data[key] === '' ||
            isEmptyObject$1(data[key])) {
          delete data[key];
        }
      });
      ...
      if (isFunction$1(globalOptions.shouldSendCallback) &&
          !globalOptions.shouldSendCallback(data)) {
        return;
      } // Backoff state: Sentry server previously responded w/ an error (e.g.
        // 429 - too many requests),
    ...
    _sanitizeData : function _sanitizeData(
        data) { return sanitize$1(data, this._globalOptions.sanitizeKeys); },
    _getUuid : function _getUuid() { return uuid4$1(); },
    _sendProcessedPayload : function _sendProcessedPayload(data, callback) {
      var self = this;
      var globalOptions = this._globalOptions;
      if (!this.isSetup())
        return; // Try and clean up the packet before sending by truncating long
                // values

      data = this._trimPacket(
          data); // ideally duplicate error testing should occur *before*
                 // dataCallback/shouldSendCallback,
      // but this would require copying an un-truncated copy of the data packet,
      // which can be arbitrarily deep (extra_data) -- could be worthwhile? will
      // revisit
      ...
      this._lastEventId =
          data.event_id ||
          (data.event_id =
               this._getUuid()); // Store outbound payload after trim
      ...
      var exception =
          data.exception &&
          data.exception.values[0]; // only capture 'sentry' breadcrumb is
                                    // autoBreadcrumbs is truthy

      if (this._globalOptions.autoBreadcrumbs &&
          this._globalOptions.autoBreadcrumbs.sentry) {
        this.captureBreadcrumb({
          category : 'sentry',
          message : exception ? (exception.type ? exception.type + ': ' : '') +
                                    exception.value
                              : data.message,
      ...
      (globalOptions.transport || this._makeRequest).call(this, {
        ...
        onSuccess : function success() {
          ...
          self._triggerEvent('success', {data : data, src : url});
        ...
        onError : function failure(error) {
          ...
          self._triggerEvent('failure', {data : data, src : url});
    ...
    _makeRequest : function _makeRequest(opts) {
      // Auth is intentionally sent as part of query string (NOT as custom HTTP
      // header) to avoid preflight CORS requests
      ...
      if (opts.options.fetchParameters) {
        evaluatedFetchParameters =
            this._evaluateHash(opts.options.fetchParameters);
      }
      ...
      if (supportsFetch$1()) {
        ...
        var fetchOptions =
            objectMerge$1(defaultFetchOptions, evaluatedFetchParameters);
        ...
        return _window$2.fetch(url, fetchOptions).then(function(response) {
          if (response.ok) {
            ...
            var error =
                new Error('Sentry error code: ' +
                          response.status); // It's called request only to keep
                                            // compatibility with XHR interface
      ...
      if (!request)
        return; // if browser doesn't support CORS (e.g. IE7), we are out of
                // luck
      ...
      if ('withCredentials' in request) {
        ...
        request = new XDomainRequest(); // xdomainrequest cannot go http ->
                                        // https (or vice versa),
      ...
      if (evaluatedHeaders) {
        each$1(evaluatedHeaders,
               function(key, value) { request.setRequestHeader(key, value); });
      }
    ...
    _logDebug : function _logDebug(level) {
      // We allow `Raven.debug` and `Raven.config(DSN, { debug: true })` to not
      // make backward incompatible API change
      if (this._originalConsoleMethods[level] &&
          (this.debug || this._globalOptions.debug)) {
        // In IE<10 console methods do not have their own 'apply' method
        Function.prototype.apply.call(this._originalConsoleMethods[level],
    ...
    _mergeContext : function _mergeContext(key, context) {
      if (isUndefined$1(context)) {
        ...
        this._globalContext[key] =
            objectMerge$1(this._globalContext[key] || {}, context);
      }
    }
  }; // Deprecations
  ...
  var _window$3 = typeof window !== 'undefined'
                      ? window
                      : typeof commonjsGlobal !== 'undefined'
                            ? commonjsGlobal
                            : typeof self !== 'undefined' ? self : {};
   ...
   * DISCLAIMER:
   *
   * Expose `Client` constructor for cases where user want to track multiple
   * "sub-applications" in one larger app. It's not meant to be used by a wide
   * audience, so pleaaase make sure that you know what you're doing before
   * using it. Accidentally calling `install` multiple times, may result in an
   * unexpected behavior that's very hard to debug.
   *
  ...
  if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') ||
                             NativeNumber('+0x1'))) {
    var NumberWrapper = function Number(value) {
      ...
      return dummy instanceof NumberWrapper
                 ...
                 ? inheritIfRequired(new NativeNumber(toNumber(it)), dummy,
                                     NumberWrapper)
                 : toNumber(it);
    };
    for (
        var keys$3 =
                descriptors
                    ...
                    : (
                          ...
                          // ES2015 (in case, if modules with ES2015 Number
                          // statics required before):
                          'EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,' +
                          'MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger')
                          .split(','),
            j$1 = 0, key$1;
        keys$3.length > j$1; j$1++) {
      if (has(NativeNumber, key$1 = keys$3[j$1]) &&
          !has(NumberWrapper, key$1)) {
        defineProperty$9(NumberWrapper, key$1,
                         getOwnPropertyDescriptor$3(NativeNumber, key$1));
      }
    }
  ...
  function _slicedToArray$1(e, t) {
    return _arrayWithHoles$1(e) || _iterableToArrayLimit$1(e, t) ||
           _nonIterableRest$1();
  }
  ...
  function getJSONP(e) {
    return new Promise(function(t, n) {
      ...
      o.addEventListener("error", function(e) { return n(e); }),
          window[r] = function(
              e) { delete window[r], document.body.removeChild(o), t(e); };
      var i = new URL(e);
      i.searchParams.set("callback", r), o.setAttribute("src", i.toString()),
          document.body.appendChild(o);
    });
  }

  var noop = function noop() {}, Console = function() {
    function e() {
      var t =
          !!(0 < arguments.length && void 0 !== arguments[0]) && arguments[0];
      _classCallCheck$1(this, e), this.enabled = window.console && t,
  ...
  function wrap$1(e, t) {
    ...
    Array.from(n).reverse().forEach(function(e, n) {
      var r = 0 < n ? t.cloneNode(!0) : t, o = e.parentNode, i = e.nextSibling;
      r.appendChild(e), i ? o.insertBefore(r, i) : o.appendChild(r);
    });
  }

  function setAttributes(e, t) {
    !is.element(e) || is.empty(t) ||
        Object.entries(t)
            .filter(function(e) {
            ...
            .forEach(function(t) {
              var n = _slicedToArray$1(t, 2), r = n[0], o = n[1];
  ...
  function createElement(e, t, n) {
    ...
    return is.object(t) && setAttributes(r, t), is.string(n) && (r.innerText = n),
           r;
  }
  ...
  function extend() {
    for (var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0]
                                                                 : {},
             t = arguments.length, n = Array(1 < t ? t - 1 : 0), r = 1;
         r < t; r++) {
      n[r - 1] = arguments[r];
    }
    ...
    return is.object(o) ? (Object.keys(o).forEach(function(t) {
      is.object(o[t]) ? (!Object.keys(e).includes(t) &&
                             Object.assign(e, _defineProperty$1({}, t, {})),
                         extend(e[t], o[t]))
                      : Object.assign(e, _defineProperty$1({}, t, o[t]));
    }),
                           extend.apply(void 0, [ e ].concat(n)))
                        : e;
  }
  ...
  var Storage = function() {
    function e(t, n) {
      ...
      _classCallCheck$1(this, e), this.enabled = r && e.supported, this.key = t,
                                  this.ttl = n;
    }
      ...
      Shr = function() {
        ...
        return _createClass$1(
                   ...
                   [
                     {
                       key : "destroy",
                       value : function value() { this.listeners(!1); }
                     },
                     {
                       key : "listeners",
                       value : function value() {
                         var e = this, t = !!(0 < arguments.length &&
                                              void 0 !== arguments[0]) &&
                                                   arguments[0]
                                               ? "addEventListener"
                                               : "removeEventListener";
                         this.elements.trigger[t](
                             "click", function(t) { return e.share(t); }, !1);
                       }
                     },
                     {
                       key : "share",
                     ...
                     },
                     {
                       ...
                       value : function value(e) {
                         if (!is.empty(this.network) &&
                           ...
                           var t = this.networkConfig.popup, n = t.width,
                               r = t.height,
                           ...
                           if (this.popup && !this.popup.closed)
                             ...
                             var i = void 0 === window.screenLeft
                                         ? window.screen.left
                                         : window.screenLeft,
                                 s = void 0 === window.screenTop
                                         ? window.screen.top
                                         : window.screenTop,
                                 a = window.screen.width / 2 - n / 2 + i,
                                 c = window.screen.height / 2 - r / 2 + s;
                             this.popup = window.open(this.href, o,
                                                      "top=".concat(c, ",left=")
                                                          .concat(a, ",width=")
                                                          .concat(n, ",height=")
                                                          .concat(r)),
                             !this.popup || this.popup.closed ||
                                     !is.boolean(this.popup.closed)
                                     ...
                                     function(n, r) {
                                       ...
                                       if (is.empty(o))
                                         ...
                                         if (t) {
                                           ...
                                           if (!is.empty(i) &&
                                               Object.keys(i).includes(
                                                   e.network)) {
                                             var s = i[e.network];
                                             return n(is.number(s) ? s : 0),
                                                    void e.console.log(
                                                        "getCount for '"
                                                            .concat(e.target,
                                                                    "' for '")
                           ...
                           function
                               value(e) {
                                 var t = !!(1 < arguments.length &&
                                            void 0 !== arguments[1]) &&
                                         arguments[1],
                                     n = this.config, r = n.count,
                                     o = n.wrapper, i = t ? e + 1 : e,
                                 ...
                                 if (0 < i || r.displayZero) {
                                   ...
                                   r.format && (1e6 < i ? c = "".concat(a(1e6), "M") : 1e3 < i && (c = "".concat(a(1e3), "K"))), is.element(
                                                                                                                                     this.elements
                                                                                                                                         .count)
                                                                                                                                     ? this.elements
                                                                                                                                           .count
                                                                                                                                     ...
                                                                                                                                     : (
                                                                                                                                           ...
                                                                                                                                           this.elements
                                                                                                                                               .trigger
                                                                                                                                               .insertAdjacentElement("after" === s ? "afterend" : "beforebegin", this.elements
                                                                                                                                                                                                                      .count));
                                 }
                               }
                     },
                     {
                       key : "href",
                       get : function get() {
                         return is.element(this.elements.trigger)
                     ...
                     },
                     {
                       ...
                       get : function get() {
                         ...
                         return Object.keys(t).find(function(
                             n) { return getDomain(e.href) === t[n].domain; });
                       }
                     },
                     {
                       key : "networkConfig",
                       get : function get() {
                         return is.empty(this.network)
                                    ? null
                     ...
                     },
                     {
                       ...
                       get : function get() {
                         ...
                         case "youtube":
                           return this.networkConfig.url(this.target,
                                                         e.youtube);
                   ...
                   [ {
                     ...
                     value : function value(t) {
                       var n = 1 < arguments.length && void 0 !== arguments[1]
                                   ...
                                   : {},
                           r = null;
                       if (is.string(t) ? r = Array.from(document.querySelectorAll(t)) : is.element(t) ? r = [t] : is.nodeList(t) ? r = Array.from(t) : is.array(t) && (r = t.filter(is.element)), is.empty(r))
                         return null;
  ...
  var check$1 = function(it) { return it && it.Math == Math && it; };
  ...
  // Nashorn ~ JDK8 bug
  var NASHORN_BUG$1 = getOwnPropertyDescriptor$4 &&
                      !nativePropertyIsEnumerable$2.call({1 : 2}, 1);
  ...
  var objectPropertyIsEnumerable$1 = {f : f$8};
  ...
  var classofRaw$1 = function(it) { return toString$2.call(it).slice(8, -1); };
  ...
  var toIndexedObject$1 = function(
      it) { return indexedObject$1(requireObjectCoercible$1(it)); };
  ...
  var has$2 = function(it, key) { return hasOwnProperty$1.call(it, key); };

  var document$3 = global_1$1.document;
  // typeof document.createElement is 'object' in old IE
  var EXISTS$1 = isObject$4(document$3) && isObject$4(document$3.createElement);

  var documentCreateElement$1 = function(
      it) { return EXISTS$1 ? document$3.createElement(it) : {}; };

  // Thank's IE8 for his funny defineProperty
  var ie8DomDefine$1 = !descriptors$1 && !fails$1(function() {
    return Object
               .defineProperty(documentCreateElement$1('div'), 'a',
                               {get : function() { return 7; }})
               .a != 7;
  });
                ...
                : function getOwnPropertyDescriptor(O, P) {
                    ...
                    if (has$2(O, P))
                      return createPropertyDescriptor$1(
                          !objectPropertyIsEnumerable$1.f.call(O, P), O[P]);
                  };

  var objectGetOwnPropertyDescriptor$1 = {f : f$9};
  ...
  var objectDefineProperty$1 = {f : f$a};

  var createNonEnumerableProperty$1 =
      descriptors$1 ? function(object, key, value) {
        return objectDefineProperty$1.f(object, key,
  ...
  if (typeof sharedStore$1.inspectSource != 'function') {
    sharedStore$1.inspectSource = function(
        it) { return functionToString$1.call(it); };
  }
  ...
  var nativeWeakMap$1 = typeof WeakMap$3 === 'function' &&
                        /native code/.test(inspectSource$1(WeakMap$3));

  var isPure$1 = false;

  var shared$1 = createCommonjsModule(function(module) {
    (module.exports = function(key, value) {
      return sharedStore$1[key] ||
  ...
  var sharedKey$1 = function(
      key) { return keys$4[key] || (keys$4[key] = uid$1(key)); };
  ...
  var enforce$1 = function(
      it) { return has$3(it) ? get$2(it) : set$3(it, {}); };
  ...
  if (nativeWeakMap$1) {
    ...
    get$2 = function(it) { return wmget$1.call(store$3, it) || {}; };
    has$3 = function(it) { return wmhas$1.call(store$3, it); };
  } else {
    ...
    get$2 = function(it) { return has$2(it, STATE$1) ? it[STATE$1] : {}; };
    has$3 = function(it) { return has$2(it, STATE$1); };
  }
  ...
  var getBuiltIn$1 = function(namespace, method) {
    return arguments.length < 2
               ? aFunction$2(path$1[namespace]) ||
                     aFunction$2(global_1$1[namespace])
  ...
  var toInteger$1 = function(argument) {
    return isNaN(argument = +argument)
               ? 0
               : (argument > 0 ? floor$6 : ceil$1)(argument);
  };
  ...
  var toLength$1 = function(argument) {
    return argument > 0 ? min$7(toInteger$1(argument), 0x1FFFFFFFFFFFFF)
                        : 0; // 2 ** 53 - 1 == 9007199254740991
  };
  ...
  // `Object.getOwnPropertyNames` method
  // https://tc39.github.io/ecma262/#sec-object.getownpropertynames
  var f$b = Object.getOwnPropertyNames ||
            function getOwnPropertyNames(
                O) { return objectKeysInternal$1(O, hiddenKeys$3); };

  var objectGetOwnPropertyNames$1 = {f : f$b};

  var f$c = Object.getOwnPropertySymbols;

  var objectGetOwnPropertySymbols$1 = {f : f$c};
  ...
  */
  ...
  var isArray$4 =
      Array.isArray || function isArray(
                           arg) { return classofRaw$1(arg) == 'Array'; };

  // `ToObject` abstract operation
  // https://tc39.github.io/ecma262/#sec-toobject
  var toObject$1 = function(
      argument) { return Object(requireObjectCoercible$1(argument)); };

  var createProperty$1 = function(object, key, value) {
    var propertyKey = toPrimitive$1(key);
    if (propertyKey in object)
      objectDefineProperty$1.f(object, propertyKey,
  ...
  var createWellKnownSymbol$1 =
      useSymbolAsUid$1 ? Symbol$2 : Symbol$2 && Symbol$2.withoutSetter || uid$1;
  ...
  var arrayMethodHasSpeciesSupport$1 = function(METHOD_NAME) {
    ...
    return engineV8Version$1 >= 51 || !fails$1(function() {
             var array = [];
             var constructor = array.constructor = {};
             constructor[SPECIES$8] = function() { return {foo : 1}; };
             return array[METHOD_NAME](Boolean).foo !== 1;
           });
  };
  ...
  var IS_CONCAT_SPREADABLE_SUPPORT$1 =
      engineV8Version$1 >= 51 || !fails$1(function() {
        var array = [];
          ...
          if (TYPE) {
            if (IS_MAP)
              ...
              case 6:
                return index; // findIndex
              case 2:
                push$1.call(target, value); // filter
              }
            else if (IS_EVERY)
              return false; // every
          }
  ...
  var arrayMethodUsesToLength$1 = function(METHOD_NAME, options) {
    if (has$2(cache$1, METHOD_NAME))
      return cache$1[METHOD_NAME];
    if (!options)
      options = {};
    var method = [][METHOD_NAME];
    ...
    return cache$1[METHOD_NAME] = !!method && !fails$1(function() {
             if (ACCESSORS && !descriptors$1)
               return true;
             var O = {length : -1};

             if (ACCESSORS)
               defineProperty$a(O, 1, {enumerable : true, get : thrower$1});
             else
               O[1] = 1;
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : !HAS_SPECIES_SUPPORT$4 || !USES_TO_LENGTH$a
  },
            {
              filter : function filter(callbackfn /* , thisArg */) {
                return $filter$2(this, callbackfn,
                                 arguments.length > 1 ? arguments[1]
                                                      : undefined);
              }
            });
  ...
  var objectKeys$1 =
      Object.keys || function keys(
                         O) { return objectKeysInternal$1(O, enumBugKeys$1); };

  // `Object.defineProperties` method
  // https://tc39.github.io/ecma262/#sec-object.defineproperties
  var objectDefineProperties$1 =
      descriptors$1 ? Object.defineProperties
                    : function defineProperties(O, Properties) {
                        anObject$1(O);
                        ...
                        var key;
                        while (length > index)
                          objectDefineProperty$1.f(O, key = keys[index++],
                                                   Properties[key]);
                        return O;
                      };
  ...
  var NullProtoObject$1 = function() {
    ...
    while (length--)
      delete NullProtoObject$1[PROTOTYPE$3][enumBugKeys$1[length]];
  ...
  if (ArrayPrototype$2[UNSCOPABLES$1] == undefined) {
    objectDefineProperty$1.f(
        ArrayPrototype$2, UNSCOPABLES$1,
        {configurable : true, value : objectCreate$1(null)});
  }

  // add a key to Array.prototype[@@unscopables]
  var addToUnscopables$1 = function(
      key) { ArrayPrototype$2[UNSCOPABLES$1][key] = true; };
  ...
  // Shouldn't skip holes
  if (FIND$1 in [])
    Array(1)[FIND$1](function() { SKIPS_HOLES$1 = false; });
  ...
  var callWithSafeIterationClosing$1 = function(iterator, fn, value, ENTRIES) {
    try {
      ...
      var returnMethod = iterator['return'];
      if (returnMethod !== undefined)
        anObject$1(returnMethod.call(iterator));
      throw error;
    }
  };
  ...
  var isArrayIteratorMethod$1 = function(it) {
    return it !== undefined &&
           (iterators$1.Array === it || ArrayPrototype$3[ITERATOR$9] === it);
  };
  ...
  var CORRECT_ARGUMENTS$1 =
      classofRaw$1(function() { return arguments; }()) == 'Arguments';
  ...
  var classof$1 = toStringTagSupport$1 ? classofRaw$1 : function(it) {
    ...
    return it === undefined
               ...
               : it === null
                     ? 'Null'
                     // @@toStringTag case
                     : typeof (tag = tryGet$1(O = Object(it),
                                              TO_STRING_TAG$6)) == 'string'
                           ? tag
                           // builtinTag case
                           : CORRECT_ARGUMENTS$1
                                 ? classofRaw$1(O)
  ...
  var getIteratorMethod$1 = function(it) {
    if (it != undefined)
      return it[ITERATOR$a] || it['@@iterator'] || iterators$1[classof$1(it)];
  };
  ...
  var arrayFrom$1 = function from(
    ...
    if (iteratorMethod != undefined &&
      ...
      result = new C();
      for (; !(step = next.call(iterator)).done; index++) {
        value = mapping ? callWithSafeIterationClosing$1(
                              iterator, mapfn, [ step.value, index ], true)
                        : step.value;
  ...
  try {
    ...
    var iteratorWithReturn$1 = {
      next : function() { return {done : !!called$1++}; },
      'return' : function() { SAFE_CLOSING$1 = true; }
    };
    iteratorWithReturn$1[ITERATOR$b] = function() { return this; };
    // eslint-disable-next-line no-throw-literal
  ...
  var INCORRECT_ITERATION$2 = !checkCorrectnessOfIteration$1(function(
      iterable) { Array.from(iterable); });
  ...
  var USES_TO_LENGTH$c =
      arrayMethodUsesToLength$1('indexOf', {ACCESSORS : true, 1 : 0});
  ...
  var objectGetPrototypeOf$1 =
      correctPrototypeGetter$1 ? Object.getPrototypeOf : function(O) {
        O = toObject$1(O);
        if (has$2(O, IE_PROTO$3))
          return O[IE_PROTO$3];
        if (typeof O.constructor == 'function' && O instanceof O.constructor) {
          return O.constructor.prototype;
        }
  ...
  if ([].keys) {
    ...
    if (!('next' in arrayIterator$1))
      BUGGY_SAFARI_ITERATORS$2 = true;
    else {
      PrototypeOfArrayIteratorPrototype$1 =
          objectGetPrototypeOf$1(objectGetPrototypeOf$1(arrayIterator$1));
      if (PrototypeOfArrayIteratorPrototype$1 !== Object.prototype)
        IteratorPrototype$3 = PrototypeOfArrayIteratorPrototype$1;
    }
  }

  if (IteratorPrototype$3 == undefined)
    IteratorPrototype$3 = {};

  // 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
  if (!has$2(IteratorPrototype$3, ITERATOR$c)) {
    createNonEnumerableProperty$1(IteratorPrototype$3, ITERATOR$c,
                                  returnThis$3);
  }
  ...
  var createIteratorConstructor$1 = function(IteratorConstructor, NAME, next) {
    var TO_STRING_TAG = NAME + ' Iterator';
    IteratorConstructor.prototype = objectCreate$1(
        IteratorPrototype$4, {next : createPropertyDescriptor$1(1, next)});
  ...
  var defineIterator$1 = function(Iterable, NAME, IteratorConstructor, next,
                                  DEFAULT, IS_SET, FORCED) {
    ...
    var nativeIterator = IterablePrototype[ITERATOR$d] ||
                         IterablePrototype['@@iterator'] ||
                         DEFAULT && IterablePrototype[DEFAULT];
    var defaultIterator = !BUGGY_SAFARI_ITERATORS$3 && nativeIterator ||
                          getIterationMethod(DEFAULT);
    var anyNativeIterator = NAME == 'Array'
                                ? IterablePrototype.entries || nativeIterator
                                : nativeIterator;
    ...
    if (anyNativeIterator) {
      CurrentIteratorPrototype =
          objectGetPrototypeOf$1(anyNativeIterator.call(new Iterable()));
      if (IteratorPrototype$5 !== Object.prototype &&
          CurrentIteratorPrototype.next) {
        if (objectGetPrototypeOf$1(CurrentIteratorPrototype) !==
            IteratorPrototype$5) {
          if (objectSetPrototypeOf$1) {
            objectSetPrototypeOf$1(CurrentIteratorPrototype,
                                   IteratorPrototype$5);
          } else if (typeof CurrentIteratorPrototype[ITERATOR$d] !=
                     'function') {
            createNonEnumerableProperty$1(CurrentIteratorPrototype, ITERATOR$d,
                                          returnThis$5);
          }
        }
        // Set @@toStringTag to native iterators
    ...
    // fix Array#{values, @@iterator}.name in V8 / FF
    if (DEFAULT == VALUES$1 && nativeIterator &&
    ...
    if (IterablePrototype[ITERATOR$d] !== defaultIterator) {
      createNonEnumerableProperty$1(IterablePrototype, ITERATOR$d,
                                    defaultIterator);
    }
    ...
    if (DEFAULT) {
      ...
      if (FORCED)
        for (KEY in methods) {
          if (BUGGY_SAFARI_ITERATORS$3 || INCORRECT_VALUES_NAME ||
              !(KEY in IterablePrototype)) {
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : ES3_STRINGS$1 || !STRICT_METHOD$5
  },
            {
              join : function join(separator) {
                return nativeJoin$1.call(toIndexedObject$1(this),
                                         separator === undefined ? ','
                                                                 : separator);
              }
            });
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : !HAS_SPECIES_SUPPORT$5 || !USES_TO_LENGTH$d
  },
            {
              map : function map(callbackfn /* , thisArg */) {
                return $map$2(this, callbackfn,
                              arguments.length > 1 ? arguments[1] : undefined);
              }
            });
  ...
  // Opera ~12 has broken Object#toString
  var BROKEN_CLASSOF$1 =
      classofRaw$1(objectCreate$1(NumberPrototype$1)) == NUMBER$1;
  ...
  // `Number` constructor
  // https://tc39.github.io/ecma262/#sec-number-constructor
  if (isForced_1$1(NUMBER$1, !NativeNumber$1(' 0o1') ||
                                 !NativeNumber$1('0b1') ||
                                 NativeNumber$1('+0x1'))) {
      ...
      return dummy instanceof NumberWrapper$1
                     ...
                     && (BROKEN_CLASSOF$1 ? fails$1(function() {
                          NumberPrototype$1.valueOf.call(dummy);
                                          ...
                                          : classofRaw$1(dummy) != NUMBER$1)
                 ? inheritIfRequired$1(new NativeNumber$1(toNumber$1(it)),
                                       dummy, NumberWrapper$1)
                 : toNumber$1(it);
    };
    for (
        var keys$5 =
                descriptors$1
                    ? getOwnPropertyNames$3(NativeNumber$1)
                    : (
                          // ES3:
                          'MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,' +
                          // ES2015 (in case, if modules with ES2015 Number
                          ...
                          .split(','),
            j$2 = 0, key$2;
        keys$5.length > j$2; j$2++) {
      if (has$2(NativeNumber$1, key$2 = keys$5[j$2]) &&
          !has$2(NumberWrapper$1, key$2)) {
        defineProperty$c(NumberWrapper$1, key$2,
                         getOwnPropertyDescriptor$6(NativeNumber$1, key$2));
      }
    }
  ...
  _export$1(
      ...
      {keys : function keys(it) { return objectKeys$1(toObject$1(it)); }});

  // `Object.prototype.toString` method implementation
  // https://tc39.github.io/ecma262/#sec-object.prototype.tostring
  var objectToString$1 =
      toStringTagSupport$1 ? {}.toString : function toString() {
  ...
  // babel-minify transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError,
  // so we use an intermediate function.
  function RE$1(s, f) { return RegExp(s, f); }
  ...
  var UNSUPPORTED_Y$4 =
      regexpStickyHelpers$1.UNSUPPORTED_Y || regexpStickyHelpers$1.BROKEN_CARET;
  ...
  var PATCH$1 =
      UPDATES_LAST_INDEX_WRONG$1 || NPCG_INCLUDED$1 || UNSUPPORTED_Y$4;
  ...
  _export$1(
      {target : 'RegExp', proto : true, forced : /./.exec !== regexpExec$1},
      {exec : regexpExec$1});
  ...
  var NOT_GENERIC$1 = fails$1(function() {
    return nativeToString$1.call({source : 'a', flags : 'b'}) != '/a/b';
  });
  // FF44- RegExp#toString has a wrong name
  ...
  var isRegexp$1 = function(it) {
    var isRegExp;
    return isObject$4(it) && ((isRegExp = it[MATCH$3]) !== undefined
                                  ? !!isRegExp
                                  : classofRaw$1(it) == 'RegExp');
  };
  ...
  },
            {
              includes : function includes(searchString /* , position = 0 */) {
                return !!~String(requireObjectCoercible$1(this))
                              .indexOf(notARegexp$1(searchString),
                                       arguments.length > 1 ? arguments[1]
                                                            : undefined);
              }
            });
  ...
  defineIterator$1(
      ...
      function(iterated) {
        setInternalState$9(
            this,
            {type : STRING_ITERATOR$1, string : String(iterated), index : 0});
        // `%StringIteratorPrototype%.next` method
        // https://tc39.github.io/ecma262/#sec-%stringiteratorprototype%.next
      },
      function next() {
  ...
  var fixRegexpWellKnownSymbolLogic$1 = function(KEY, length, exec, sham) {
    ...
    var DELEGATES_TO_EXEC =
        DELEGATES_TO_SYMBOL && !fails$1(function() {
          // Symbol-named RegExp methods call .exec
          var execCalled = false;
          var re = /a/;
    ...
    if (!DELEGATES_TO_SYMBOL || !DELEGATES_TO_EXEC ||
        (KEY === 'replace' &&
         !(REPLACE_SUPPORTS_NAMED_GROUPS$1 && REPLACE_KEEPS_$0$1 &&
    ...
    if (sham)
      createNonEnumerableProperty$1(RegExp.prototype[SYMBOL], 'sham', true);
  };
      ...
      'search', 1, function(SEARCH, nativeSearch, maybeCallNative) {
        return [
          ...
          function(regexp) {
            ...
            var previousLastIndex = rx.lastIndex;
            if (!sameValue$1(previousLastIndex, 0))
              rx.lastIndex = 0;
            var result = regexpExecAbstract$1(rx, S);
            if (!sameValue$1(rx.lastIndex, previousLastIndex))
              rx.lastIndex = previousLastIndex;
            return result === null ? -1 : result.index;
          }
        ];
  ...
  var freezing = !fails$1(
      function() { return Object.isExtensible(Object.preventExtensions({})); });
  ...
  var internalMetadata = createCommonjsModule(function(module) {
    ...
    var onFreeze = function(it) {
      if (freezing && meta.REQUIRED && isExtensible(it) && !has$2(it, METADATA))
        setMetadata(it);
      return it;
    };
  ...
  var iterate_1$1 = createCommonjsModule(function(module) {
    ...
    var iterate = module.exports = function(iterable, fn, that, AS_ENTRIES,
                                            IS_ITERATOR) {
      ...
      if (IS_ITERATOR) {
        ...
        if (isArrayIteratorMethod$1(iterFn)) {
          for (index = 0, length = toLength$1(iterable.length); length > index;
               index++) {
            result = AS_ENTRIES
                         ? boundFunction(anObject$1(step = iterable[index])[0],
                                         step[1])
                         : boundFunction(iterable[index]);
            if (result && result instanceof Result)
              return result;
      ...
      next = iterator.next;
      while (!(step = next.call(iterator)).done) {
        result = callWithSafeIterationClosing$1(iterator, boundFunction,
                                                step.value, AS_ENTRIES);
        if (typeof result == 'object' && result && result instanceof Result)
          return result;
      }
  ...
  var collection = function(CONSTRUCTOR_NAME, wrapper, common) {
    ...
    if (isForced_1$1(
            ...
            typeof NativeConstructor != 'function' ||
                !(IS_WEAK || NativePrototype.forEach && !fails$1(function() {
                               new NativeConstructor().entries().next();
                             })))) {
      // create collection constructor
      Constructor =
          common.getConstructor(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER);
      ...
      // not close it correctly eslint-disable-next-line no-new
      var ACCEPT_ITERABLES = checkCorrectnessOfIteration$1(function(
          iterable) { new NativeConstructor(iterable); });
      ...
      if (!ACCEPT_ITERABLES) {
        Constructor = wrapper(function(dummy, iterable) {
          ...
          var that =
              inheritIfRequired$1(new NativeConstructor(), dummy, Constructor);
          if (iterable != undefined)
            iterate_1$1(iterable, that[ADDER], that, IS_MAP);
          return that;
        });
    ...
    _export$1({global : true, forced : Constructor != NativeConstructor},
              exported);
  ...
  var UncaughtFrozenStore = function() { this.entries = []; };

  var findUncaughtFrozen = function(store, key) {
    return find$1(store.entries, function(it) { return it[0] === key; });
  };
  ...
  UncaughtFrozenStore.prototype = {
    ...
    'delete' : function(key) {
      var index =
          findIndex(this.entries, function(it) { return it[0] === key; });
      if (~index)
  ...
  var collectionWeak = {
    getConstructor : function(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
      var C = wrapper(function(that, iterable) {
        ...
        setInternalState$a(
            that, {type : CONSTRUCTOR_NAME, id : id$2++, frozen : undefined});
        if (iterable != undefined)
          iterate_1$1(iterable, that[ADDER], that, IS_MAP);
      });
      ...
      redefineAll$1(
          ...
          IS_MAP ? {
            ...
            set : function set(key, value) { return define(this, key, value); }
          }
                 : {
                     // 23.4.3.1 WeakSet.prototype.add(value)
                     add : function add(
                         value) { return define(this, value, true); }
                   });
  ...
  var es_weakMap = createCommonjsModule(function(module) {
    ...
    var $WeakMap = module.exports =
        collection('WeakMap', wrapper, collectionWeak);
      ...
      redefineAll$1(WeakMapPrototype, {
        ...
        get : function get(key) {
          if (isObject$4(key) && !isExtensible(key)) {
            ...
            if (!state.frozen)
              state.frozen = new InternalWeakMap();
            return nativeHas.call(this, key) ? nativeGet.call(this, key)
        ...
        set : function set(key, value) {
          if (isObject$4(key) && !isExtensible(key)) {
            ...
            if (!state.frozen)
              state.frozen = new InternalWeakMap();
            nativeHas.call(this, key) ? nativeSet.call(this, key, value)
  ...
  for (var COLLECTION_NAME$2 in domIterables$1) {
    ...
    if (CollectionPrototype$2) {
      // some Chrome versions have non-configurable methods on DOMTokenList
      if (CollectionPrototype$2[ITERATOR$e] !== ArrayValues$1)
        try {
          createNonEnumerableProperty$1(CollectionPrototype$2, ITERATOR$e,
                                        ArrayValues$1);
        } catch (error) {
          CollectionPrototype$2[ITERATOR$e] = ArrayValues$1;
        }
      if (!CollectionPrototype$2[TO_STRING_TAG$8]) {
        createNonEnumerableProperty$1(CollectionPrototype$2, TO_STRING_TAG$8,
                                      COLLECTION_NAME$2);
      }
      if (domIterables$1[COLLECTION_NAME$2])
        for (var METHOD_NAME$1 in es_array_iterator$1) {
          // some Chrome versions have non-configurable methods on DOMTokenList
          if (CollectionPrototype$2[METHOD_NAME$1] !==
              es_array_iterator$1[METHOD_NAME$1])
            try {
              createNonEnumerableProperty$1(CollectionPrototype$2,
                                            METHOD_NAME$1,
                                            es_array_iterator$1[METHOD_NAME$1]);
            } catch (error) {
              CollectionPrototype$2[METHOD_NAME$1] =
                  es_array_iterator$1[METHOD_NAME$1];
            }
        }
    }
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : !STRICT_METHOD$6 || !USES_TO_LENGTH$e
  },
            {
              every : function every(callbackfn /* , thisArg */) {
                return $every$1(this, callbackfn,
                                arguments.length > 1 ? arguments[1]
                                                     : undefined);
              }
            });
  ...
  var
      arrayForEach$1 =
          (!STRICT_METHOD$7 || !USES_TO_LENGTH$f) ? function forEach(callbackfn /* , thisArg */) {
            return $forEach$3(this, callbackfn,
                              arguments.length > 1 ? arguments[1] : undefined);
          } : [].forEach;
  ...
  // https://tc39.github.io/ecma262/#sec-array.prototype.foreach
  _export$1(
      {target : 'Array', proto : true, forced : [].forEach != arrayForEach$1},
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : NEGATIVE_ZERO$2 || !STRICT_METHOD$8 || !USES_TO_LENGTH$g
  },
            {
              indexOf : function indexOf(searchElement /* , fromIndex = 0 */) {
  ...
  var speciesConstructor$1 = function(O, defaultConstructor) {
    ...
    var S;
    return C === undefined || (S = anObject$1(C)[SPECIES$a]) == undefined
               ? defaultConstructor
               : aFunction$3(S);
  };
  ...
  // `AdvanceStringIndex` abstract operation
  // https://tc39.github.io/ecma262/#sec-advancestringindex
  var advanceStringIndex$1 = function(
      S, index,
      unicode) { return index + (unicode ? charAt$3(S, index).length : 1); };
  ...
  // babel-minify transpiles RegExp('x', 'y') -> /x/y and it causes SyntaxError
  var SUPPORTS_Y$1 =
      !fails$1(function() { return !RegExp(MAX_UINT32$1, 'y'); });
      ...
      'split', 2, function(SPLIT, nativeSplit, maybeCallNative) {
          ...
          internalSplit = function(separator, limit) {
            ...
            while (match = regexpExec$1.call(separatorCopy, string)) {
              ...
              if (lastIndex > lastLastIndex) {
                output.push(string.slice(lastLastIndex, match.index));
                if (match.length > 1 && match.index < string.length)
                  arrayPush$1.apply(output, match.slice(1));
                lastLength = match[0].length;
                lastLastIndex = lastIndex;
                if (output.length >= lim)
                  break;
        ...
        return [
          ...
          function(regexp, limit) {
            ...
            var unicodeMatching = rx.unicode;
            var flags = (rx.ignoreCase ? 'i' : '') + (rx.multiline ? 'm' : '') +
                        (rx.unicode ? 'u' : '') + (SUPPORTS_Y$1 ? 'y' : 'g');

            // ^(? + rx + ) is needed, in combination with some S slicing, to
            // simulate the 'y' flag.
            var splitter =
                new C(SUPPORTS_Y$1 ? rx : '^(?:' + rx.source + ')', flags);
            var lim = limit === undefined ? MAX_UINT32$1 : limit >>> 0;
            if (lim === 0)
              return [];
            if (S.length === 0)
              return regexpExecAbstract$1(splitter, S) === null ? [ S ] : [];
            var p = 0;
            var q = 0;
            var A = [];
            while (q < S.length) {
              ...
              var z =
                  regexpExecAbstract$1(splitter, SUPPORTS_Y$1 ? S : S.slice(q));
              var e;
              if (z === null || (e = min$9(toLength$1(splitter.lastIndex +
                                                      (SUPPORTS_Y$1 ? 0 : q)),
                                           S.length)) === p) {
  ...
  var stringTrimForced = function(METHOD_NAME) {
    return fails$1(function() {
      return !!whitespaces$1[METHOD_NAME]() || non[METHOD_NAME]() != non ||
  ...
  _export$1(
      ...
      {trim : function trim() { return $trim(this); }});
  ...
  for (var COLLECTION_NAME$3 in domIterables$1) {
    ...
    if (CollectionPrototype$3 &&
      ...
      try {
        createNonEnumerableProperty$1(CollectionPrototype$3, 'forEach',
                                      arrayForEach$1);
      } catch (error) {
        CollectionPrototype$3.forEach = arrayForEach$1;
      }
  ...
  var nativeUrl$1 = !fails$1(function() {
    ...
    return (isPure$1 && !url.toJSON) || !searchParams.sort ||
           url.href !== 'http://a/c%20d?a=1&c=3' ||
           searchParams.get('c') !== '3' ||
           String(new URLSearchParams('?a=1')) !== 'a=1' ||
      ...
      for (i = 0; i < input.length; i++) {
        ...
        if (currentValue == n) {
          ...
          for (var k = base$1; /* no condition */; k += base$1) {
            var t =
                k <= bias ? tMin$1 : (k >= bias + tMax$1 ? tMax$1 : k - bias);
            if (q < t)
              break;
            var qMinusT = q - t;
          ...
          bias = adapt$1(delta, handledCPCountPlusOne,
                         handledCPCount == basicLength);
          delta = 0;
          ++handledCPCount;
        }
  ...
  var stringPunycodeToAscii$1 = function(input) {
    var encoded = [];
    var labels =
        input.toLowerCase().replace(regexSeparators$1, '\u002E').split('.');
    var i, label;
    for (i = 0; i < labels.length; i++) {
      label = labels[i];
      encoded.push(regexNonASCII$1.test(label) ? 'xn--' + encode$1(label)
                                               : label);
    }
    return encoded.join('.');
  };
  ...
  var getInternalIteratorState$1 =
      internalState$1.getterFor(URL_SEARCH_PARAMS_ITERATOR$1);

  var plus$1 = /\+/g;
  var sequences$1 = Array(4);

  var percentSequence$1 = function(bytes) {
    return sequences$1[bytes - 1] ||
           (sequences$1[bytes - 1] =
                RegExp('((?:%[\\da-f]{2}){' + bytes + '})', 'gi'));
  };
  ...
  var replacer$1 = function(match) { return replace$1[match]; };

  var serialize$1 = function(
      it) { return encodeURIComponent(it).replace(find$2, replacer$1); };
  ...
  redefineAll$1(URLSearchParamsPrototype$1, {
    ...
    // `URLSearchParams.prototype.keys` method
    keys :
        function keys() { return new URLSearchParamsIterator$1(this, 'keys'); },
    // `URLSearchParams.prototype.values` method
    values : function
        values() { return new URLSearchParamsIterator$1(this, 'values'); },
    // `URLSearchParams.prototype.entries` method
    entries : function
        entries() { return new URLSearchParamsIterator$1(this, 'entries'); }
  },
                {enumerable : true});

  // `URLSearchParams.prototype[@@iterator]` method
  redefine$1(URLSearchParamsPrototype$1, ITERATOR$g,
  ...
  // Wrap `fetch` for correct work with polyfilled `URLSearchParams`
  // https://github.com/zloirock/core-js/issues/674
  if (!nativeUrl$1 && typeof $fetch$2 == 'function' &&
      typeof Headers$2 == 'function') {
        ...
        if (arguments.length > 1) {
          ...
          if (isObject$4(init)) {
            ...
            if (classof$1(body) === URL_SEARCH_PARAMS$1) {
              headers =
                  init.headers ? new Headers$2(init.headers) : new Headers$2();
              if (!headers.has('content-type')) {
                headers.set('content-type',
                            'application/x-www-form-urlencoded;charset=UTF-8');
              }
  ...
  var FORBIDDEN_HOST_CODE_POINT_EXCLUDING_PERCENT$1 =
      /[\u0000\u0009\u000A\u000D #/:?@[\\]]/;
  // eslint-disable-next-line no-control-regex
  var LEADING_AND_TRAILING_C0_CONTROL_OR_SPACE$1 =
      /^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g;
  // eslint-disable-next-line no-control-regex
  ...
  var parseHost$1 = function(url, input) {
    ...
    if (input.charAt(0) == '[') {
      ...
      for (index = 0; index < codePoints.length; index++) {
        result +=
            percentEncode$1(codePoints[index], C0ControlPercentEncodeSet$1);
      }
      url.host = result;
    } else {
      input = stringPunycodeToAscii$1(input);
      if (FORBIDDEN_HOST_CODE_POINT$1.test(input))
        return INVALID_HOST$1;
  ...
  var parseIPv4$1 = function(input) {
    ...
    for (index = 0; index < partsLength; index++) {
      number = numbers[index];
      if (index == partsLength - 1) {
        if (number >= pow$2(256, 5 - partsLength))
          return null;
      } else if (number > 255)
        return null;
    }
  ...
  var fragmentPercentEncodeSet$1 =
      objectAssign$1({}, C0ControlPercentEncodeSet$1,
                     {' ' : 1, '"' : 1, '<' : 1, '>' : 1, '`' : 1});
  var pathPercentEncodeSet$1 = objectAssign$1(
      {}, fragmentPercentEncodeSet$1, {'#' : 1, '?' : 1, '{' : 1, '}' : 1});
  ...
  var percentEncode$1 = function(char, set) {
    ...
    return code > 0x20 && code < 0x7F && !has$2(set, char)
               ? char
               : encodeURIComponent(char);
  };
  ...
  var isSpecial$1 = function(
      url) { return has$2(specialSchemes$1, url.scheme); };

  var includesCredentials$1 = function(
      url) { return url.username != '' || url.password != ''; };
  ...
  var parseURL$1 = function(url, input, stateOverride, base) {
    ...
    while (pointer <= codePoints.length) {
      ...
      case SCHEME$1:
        if (char && (ALPHANUMERIC$1.test(char) || char == '+' || char == '-' ||
                     char == '.')) {
          buffer += char.toLowerCase();
        } else if (char == ':') {
          if (stateOverride &&
      ...
      case AUTHORITY$1:
        if (char == '@') {
          ...
          for (var i = 0; i < bufferCodePoints.length; i++) {
            ...
            var encodedCodePoints =
                percentEncode$1(codePoint, userinfoPercentEncodeSet$1);
            if (seenPasswordToken)
              url.password += encodedCodePoints;
            else
              url.username += encodedCodePoints;
          ...
          buffer = '';
        } else if (char == EOF$1 || char == '/' || char == '?' || char == '#' ||
                   (char == '\\' && isSpecial$1(url))) {
          if (seenAt && buffer == '')
            return INVALID_AUTHORITY$1;
      ...
      case HOSTNAME$1:
        if (stateOverride && url.scheme == 'file') {
          ...
          buffer = '';
          state = PORT$1;
          if (stateOverride == HOSTNAME$1)
            return;
        } else if (char == EOF$1 || char == '/' || char == '?' || char == '#' ||
                   (char == '\\' && isSpecial$1(url))) {
          if (isSpecial$1(url) && buffer == '')
            return INVALID_HOST$1;
          if (stateOverride && buffer == '' &&
              (includesCredentials$1(url) || url.port !== null))
            return;
      ...
      case PORT$1:
        if (DIGIT$1.test(char)) {
          buffer += char;
                   ...
                   (char == '\\' && isSpecial$1(url)) || stateOverride) {
          if (buffer != '') {
            var port = parseInt(buffer, 10);
            if (port > 0xFFFF)
              return INVALID_PORT$1;
            url.port =
      ...
      case FILE$1:
        ...
        if (char == '/' || char == '\\')
          ...
          if (char == EOF$1) {
            ...
            if (!startsWithWindowsDriveLetter$1(
                    codePoints.slice(pointer).join(''))) {
              url.host = base.host;
              url.path = base.path.slice();
      ...
      case QUERY$1:
        if (!stateOverride && char == '#') {
          ...
          if (char == "'" && isSpecial$1(url))
            url.query += '%27';
          else if (char == '#')
            url.query += '%23';
          else
            url.query += percentEncode$1(char, C0ControlPercentEncodeSet$1);
        }
        break;

      case FRAGMENT$1:
        if (char != EOF$1)
          url.fragment += percentEncode$1(char, fragmentPercentEncodeSet$1);
        break;
      }
  ...
  var getOrigin$1 = function() {
    ...
    if (scheme == 'file' || !isSpecial$1(url))
      return 'null';
    return scheme + '://' + serializeHost$1(url.host) +
           (port !== null ? ':' + port : '');
  };

  var getProtocol$1 =
      function() { return getInternalURLState$1(this).scheme + ':'; };

  var getUsername$1 =
      function() { return getInternalURLState$1(this).username; };

  var getPassword$1 =
      function() { return getInternalURLState$1(this).password; };
  ...
  var getSearchParams$1 =
      function() { return getInternalURLState$1(this).searchParams; };
  ...
  if (descriptors$1) {
    objectDefineProperties$1(URLPrototype$1, {
      // `URL.prototype.href` accessors pair
      // https://url.spec.whatwg.org/#dom-url-href
      href : accessorDescriptor$1(serializeURL$1,
                                  function(href) {
                                    var url = getInternalURLState$1(this);
                                    var urlString = String(href);
                                    ...
                                    if (failure)
                                      throw TypeError(failure);
                                    getInternalSearchParamsState$1(
                                        url.searchParams)
                                        .updateSearchParams(url.query);
                                  }),
      // `URL.prototype.origin` getter
      ...
      // `URL.prototype.protocol` accessors pair
      // https://url.spec.whatwg.org/#dom-url-protocol
      protocol : accessorDescriptor$1(getProtocol$1,
                                      function(protocol) {
                                        var url = getInternalURLState$1(this);
                                        parseURL$1(url, String(protocol) + ':',
                                                   SCHEME_START$1);
                                      }),
      // `URL.prototype.username` accessors pair
      // https://url.spec.whatwg.org/#dom-url-username
      username : accessorDescriptor$1(
          getUsername$1,
          function(username) {
            var url = getInternalURLState$1(this);
            var codePoints = arrayFrom$1(String(username));
            if (cannotHaveUsernamePasswordPort$1(url))
              return;
            url.username = '';
            for (var i = 0; i < codePoints.length; i++) {
              url.username +=
                  percentEncode$1(codePoints[i], userinfoPercentEncodeSet$1);
            }
          }),
      // `URL.prototype.password` accessors pair
      // https://url.spec.whatwg.org/#dom-url-password
      password : accessorDescriptor$1(
          getPassword$1,
          function(password) {
            var url = getInternalURLState$1(this);
      ...
      // `URL.prototype.host` accessors pair
      // https://url.spec.whatwg.org/#dom-url-host
      host : accessorDescriptor$1(getHost$1,
                                  function(host) {
                                    var url = getInternalURLState$1(this);
                                    if (url.cannotBeABaseURL)
                                      return;
      ...
      // `URL.prototype.hostname` accessors pair
      // https://url.spec.whatwg.org/#dom-url-hostname
      hostname : accessorDescriptor$1(getHostname$1,
                                      function(hostname) {
                                        var url = getInternalURLState$1(this);
                                        if (url.cannotBeABaseURL)
                                          return;
                                        parseURL$1(url, String(hostname),
                                                   HOSTNAME$1);
                                      }),
      // `URL.prototype.port` accessors pair
      // https://url.spec.whatwg.org/#dom-url-port
      port : accessorDescriptor$1(getPort$1,
                                  function(port) {
                                    var url = getInternalURLState$1(this);
                                    if (cannotHaveUsernamePasswordPort$1(url))
                                      return;
                                    ...
                                    if (port == '')
                                      ...
                                      parseURL$1(url, port, PORT$1);
                                  }),
      // `URL.prototype.pathname` accessors pair
      // https://url.spec.whatwg.org/#dom-url-pathname
      pathname : accessorDescriptor$1(getPathname$1,
                                      function(pathname) {
                                        var url = getInternalURLState$1(this);
                                        if (url.cannotBeABaseURL)
                                          return;
                                        url.path = [];
                                        parseURL$1(url, pathname + '',
                                                   PATH_START$1);
                                      }),
      // `URL.prototype.search` accessors pair
      // https://url.spec.whatwg.org/#dom-url-search
      search : accessorDescriptor$1(getSearch$1,
                                    function(search) {
                                      var url = getInternalURLState$1(this);
                                      search = String(search);
                                      if (search == '') {
      ...
      // `URL.prototype.hash` accessors pair
      // https://url.spec.whatwg.org/#dom-url-hash
      hash : accessorDescriptor$1(getHash$1,
                                  function(hash) {
                                    var url = getInternalURLState$1(this);
                                    hash = String(hash);
                                    if (hash == '') {
  ...
  // `URL.prototype.toJSON` method
  // https://url.spec.whatwg.org/#dom-url-tojson
  redefine$1(URLPrototype$1, 'toJSON',
             function toJSON() { return serializeURL$1.call(this); },
             {enumerable : true});

  // `URL.prototype.toString` method
  // https://url.spec.whatwg.org/#URL-stringification-behavior
  redefine$1(URLPrototype$1, 'toString',
             function toString() { return serializeURL$1.call(this); },
             {enumerable : true});
  ...
  if (NativeURL$1) {
    ...
    if (nativeCreateObjectURL$1)
      redefine$1(URLConstructor$1, 'createObjectURL',
                 function createObjectURL(blob) {
    ...
    if (nativeRevokeObjectURL$1)
      redefine$1(URLConstructor$1, 'revokeObjectURL',
                 function revokeObjectURL(url) {
  ...
  _export$1({target : 'Object', stat : true},
            {entries : function entries(O) { return $entries$1(O); }});
        ...
        return [
          ...
          function(regexp, replaceValue) {
            ...
            while (true) {
              ...
              var matchStr = String(result[0]);
              if (matchStr === '')
                rx.lastIndex = advanceStringIndex$1(S, toLength$1(rx.lastIndex),
                                                    fullUnicode);
            }
            ...
            for (var i = 0; i < results.length; i++) {
              ...
              var matched = String(result[0]);
              var position =
                  max$5(min$a(toInteger$1(result.index), S.length), 0);
              var captures = [];
              // NOTE: This is equivalent to
              //   captures = result.slice(1).map(maybeToString)
              // but for some reason `nativeSlice.call(result, 1,
  ...
  var isObject$5 = function isObject(
  ...
  var isEmpty$1 = function isEmpty(input) {
    return isNullOrUndefined$1(input) ||
           (isString$3(input) || isArray$5(input) || isNodeList$1(input)) &&
               !input.length ||
           isObject$5(input) && !Object.keys(input).length;
  };
      ...
      'match', 1, function(MATCH, nativeMatch, maybeCallNative) {
        return [
          ...
          function(regexp) {
            ...
            if (!rx.global)
              return regexpExecAbstract$1(rx, S);
                ...
                value : function setup(target) {
                  ...
                  if (is$1.empty(target) || is$1.string(target)) {
                    targets = Array.from(document.querySelectorAll(
                        is$1.string(target) ? target : 'input[type="range"]'));
  ...
  var engineIsIos$1 =
      /(iphone|ipod|ipad).*applewebkit/i.test(engineUserAgent$1);
  ...
  var runner$1 = function(id) { return function() { run$1(id); }; };

  var listener$1 = function(event) { run$1(event.data); };

  var post$1 = function(id) {
    // old engines have not location.origin
    global_1$1.postMessage(id + '',
  ...
  if (!set$4 || !clear$1) {
    ...
    clear$1 = function clearImmediate(id) { delete queue$1[id]; };
    // Node.js 0.8-
    if (classofRaw$1(process$5) == 'process') {
      defer$1 = function(id) { process$5.nextTick(runner$1(id)); };
      // Sphere (JS game engine) Dispatch API
    } else if (Dispatch$1 && Dispatch$1.now) {
      defer$1 = function(id) { Dispatch$1.now(runner$1(id)); };
      // Browsers with MessageChannel, includes WebWorkers
      // except iOS - https://github.com/zloirock/core-js/issues/624
      ...
      // Browsers with postMessage, skip WebWorkers
      // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    } else if (global_1$1.addEventListener &&
               typeof postMessage == 'function' && !global_1$1.importScripts &&
               !fails$1(post$1)) {
      defer$1 = post$1;
      ...
      defer$1 = function(id) {
        html$1.appendChild(documentCreateElement$1(
            'script'))[ONREADYSTATECHANGE$1] = function() {
      ...
      defer$1 = function(id) { setTimeout(runner$1(id), 0); };
    }
  }

  var task$2 = {set : set$4, clear : clear$1};
  ...
  var MutationObserver$2 =
      global_1$1.MutationObserver || global_1$1.WebKitMutationObserver;
  var process$6 = global_1$1.process;
  var Promise$2 = global_1$1.Promise;
  var IS_NODE$2 = classofRaw$1(process$6) == 'process';
  // Node.js 11 shows ExperimentalWarning on getting `queueMicrotask`
  var queueMicrotaskDescriptor$1 =
      getOwnPropertyDescriptor$7(global_1$1, 'queueMicrotask');
  ...
  if (!queueMicrotask$1) {
    flush$1 = function() {
      var parent, fn;
      if (IS_NODE$2 && (parent = process$6.domain))
        parent.exit();
      while (head$1) {
        fn = head$1.fn;
        head$1 = head$1.next;
    ...
    // Node.js
    if (IS_NODE$2) {
      notify$2 = function() { process$6.nextTick(flush$1); };
      // browsers with MutationObserver, except iOS -
      // https://github.com/zloirock/core-js/issues/339
      ...
      notify$2 = function() { node$1.data = toggle$1 = !toggle$1; };
      // environments with maybe non-completely correct, but existent Promise
    } else if (Promise$2 && Promise$2.resolve) {
      // Promise.resolve without an argument throws an error in LG WebOS 2
      promise$1 = Promise$2.resolve(undefined);
      then$1 = promise$1.then;
      notify$2 = function() { then$1.call(promise$1, flush$1); };
      // for other environments - macrotask based on:
      // - setImmediate
      // - MessageChannel
      // - window.postMessag
  ...
  // 25.4.1.5 NewPromiseCapability(C)
  var f$d = function(C) { return new PromiseCapability$1(C); };

  var newPromiseCapability$2 = {f : f$d};
  ...
  var DISPATCH_EVENT$1 =
      !!(document$4 && document$4.createEvent && global_1$1.dispatchEvent);
  ...
  var FORCED$9 = isForced_1$1(PROMISE$1, function() {
    var GLOBAL_CORE_JS_PROMISE =
        inspectSource$1(PromiseConstructor$1) !== String(PromiseConstructor$1);
    if (!GLOBAL_CORE_JS_PROMISE) {
      // V8 6.6 (Node 10 and Chrome 66) have a bug with resolving custom
      // thenables https://bugs.chromium.org/p/chromium/issues/detail?id=830565
      // We can't detect it synchronously, so just check versions
      if (engineV8Version$1 === 66)
        return true;
      // Unhandled rejections tracking support, NodeJS Promise without it fails
      // @@species test
      if (!IS_NODE$3 && typeof PromiseRejectionEvent != 'function')
        return true;
    }
    // We can't use @@species feature detection in V8 since it causes
    // deoptimization and performance degradation
    // https://github.com/zloirock/core-js/issues/679
    if (engineV8Version$1 >= 51 && /native code/.test(PromiseConstructor$1))
      return false;
    // Detect correctness of subclassing with @@species support
  ...
  var INCORRECT_ITERATION$3 =
      FORCED$9 || !checkCorrectnessOfIteration$1(function(iterable) {
  ...
  var isThenable$1 = function(it) {
    var then;
    return isObject$4(it) && typeof (then = it.then) == 'function' ? then
                                                                   : false;
  };
          ...
          if (handler) {
            if (!ok) {
              if (state.rejection === UNHANDLED$1)
                onHandleUnhandled$1(promise, state);
      ...
      if (IS_UNHANDLED) {
        result = perform$1(function() {
          if (IS_NODE$3) {
            ...
            dispatchEvent$1(UNHANDLED_REJECTION$1, promise, value);
        });
        // Browsers should not trigger `rejectionHandled` event if it was
        // handled here, NodeJS - should
        state.rejection =
            IS_NODE$3 || isUnhandled$1(state) ? UNHANDLED$1 : HANDLED$1;
        if (result.error)
          throw result.value;
      }
    });
  ...
  var isUnhandled$1 = function(
      state) { return state.rejection !== HANDLED$1 && !state.parent; };
  ...
  var onHandleUnhandled$1 = function(promise, state) {
    task$3.call(global_1$1, function() {
      if (IS_NODE$3) {
        ...
        dispatchEvent$1(REJECTION_HANDLED$1, promise, state.value);
    });
  };
    ...
    try {
      ...
      if (then) {
        microtask$1(function() {
          var wrapper = {done : false};
          try {
            then.call(value, bind$1(internalResolve$1, promise, wrapper, state),
  ...
  if (FORCED$9) {
    ...
    PromiseConstructor$1 = function Promise(executor) {
      ...
      try {
        executor(bind$1(internalResolve$1, this, state),
                 bind$1(internalReject$1, this, state));
      } catch (error) {
    ...
    Internal$1.prototype = redefineAll$1(PromiseConstructor$1.prototype, {
      ...
      then : function then(onFulfilled, onRejected) {
        ...
        var reaction = newPromiseCapability$3(
            speciesConstructor$1(this, PromiseConstructor$1));
        reaction.ok = typeof onFulfilled == 'function' ? onFulfilled : true;
        reaction.fail = typeof onRejected == 'function' && onRejected;
    ...
    if (typeof nativePromiseConstructor$1 == 'function') {
      ...
      // wrap native Promise#then for native async functions
      redefine$1(nativePromiseConstructor$1.prototype,
                 'then', function then(onFulfilled, onRejected) {
                   var that = this;
      ...
      // wrap fetch result
      if (typeof $fetch$3 == 'function')
        _export$1({global : true, enumerable : true, forced : true}, {
          // eslint-disable-next-line no-unused-vars
          fetch : function fetch(input /* , init */) {
            return promiseResolve$1(PromiseConstructor$1,
                                    $fetch$3.apply(global_1$1, arguments));
          }
        });
    }
  }
  ...
  _export$1({target : PROMISE$1, stat : true, forced : FORCED$9}, {
    // `Promise.resolve` method
    // https://tc39.github.io/ecma262/#sec-promise.resolve
    resolve : function resolve(x) { return promiseResolve$1(this, x); }
  });
  ...
  _export$1(
      ...
      },
      {
        startsWith : function startsWith(searchString /* , position = 0 */) {
          ...
          var index = toLength$1(min$b(
              arguments.length > 1 ? arguments[1] : undefined, that.length));
  ...
  var isNullOrUndefined$2 = function isNullOrUndefined(
      input) { return input === null || typeof input === 'undefined'; };

  var isObject$6 = function isObject(
      input) { return getConstructor$2(input) === Object; };

  var isNumber$2 = function isNumber(input) {
    return getConstructor$2(input) === Number && !Number.isNaN(input);
  };

  var isString$4 = function isString(
      input) { return getConstructor$2(input) === String; };

  var isBoolean$2 = function isBoolean(
      input) { return getConstructor$2(input) === Boolean; };

  var isFunction$4 = function isFunction(
      input) { return getConstructor$2(input) === Function; };

  var isArray$6 = function isArray(input) { return Array.isArray(input); };

  var isWeakMap = function isWeakMap(
      input) { return instanceOf$2(input, WeakMap); };

  var isNodeList$2 = function isNodeList(
      input) { return instanceOf$2(input, NodeList); };

  var isElement$2 = function isElement(
      input) { return instanceOf$2(input, Element); };

  var isTextNode = function isTextNode(
      input) { return getConstructor$2(input) === Text; };

  var isEvent$2 = function isEvent(
      input) { return instanceOf$2(input, Event); };

  var isKeyboardEvent = function isKeyboardEvent(
      input) { return instanceOf$2(input, KeyboardEvent); };

  var isCue = function isCue(input) {
    return instanceOf$2(input, window.TextTrackCue) ||
           instanceOf$2(input, window.VTTCue);
  };

  var isTrack = function isTrack(input) {
    return instanceOf$2(input, TextTrack) ||
           !isNullOrUndefined$2(input) && isString$4(input.kind);
  };

  var isPromise = function isPromise(
      input) { return instanceOf$2(input, Promise); };

  var isEmpty$2 = function isEmpty(input) {
    return isNullOrUndefined$2(input) ||
           (isString$4(input) || isArray$6(input) || isNodeList$2(input)) &&
               !input.length ||
           isObject$6(input) && !Object.keys(input).length;
  };
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : !STRICT_METHOD$a || !USES_TO_LENGTH$i
  },
            {
              reduce : function reduce(callbackfn /* , initialValue */) {
                return $reduce$2(this, callbackfn, arguments.length,
                                 arguments.length > 1 ? arguments[1]
                                                      : undefined);
              }
            });
  ...
  function replaceElement(newChild, oldChild) {
    if (!is$2.element(oldChild) || !is$2.element(oldChild.parentNode) ||
        !is$2.element(newChild)) {
      return null;
    }
