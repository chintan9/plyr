...
(() => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    Raven.context(() => {
      ...
      const historySupport =
          Boolean(window.history && window.history.pushState);
      ...
      function setSource(type, init) {
        // Bail if new type isn't known, it's the current type, or current type
        // is empty (video is default) and new type is video
  ...
  if (env.prod) {
    Raven.config('https://d4ad9866ad834437a4754e23937071e4@sentry.io/305555')
        .install();
  }
})();
