'object' == typeof navigator &&
    (function(e, t) {
        ...
        var A,
                        ...
                        [
                            {
                                ...
                                value: function(e) {
                                    ...
                                    if (
                                        (T(e) || y(e)
                                            ? (n = Array.from(
                                                  document.querySelectorAll(y(e) ? e : 'input[type="range"]'),
                                              ))
                                            : w(e)
                                            ? (n = [e])
                                            : b(e)
            ...
            D = I,
            H = function(e) {
                return N(e) === Number && !Number.isNaN(e);
            },
            F = L,
            R = function(e) {
                return N(e) === Boolean;
            ...
            Y = function(e) {
                return M(e, TextTrack) || (!x(e) && L(e.kind));
            },
            Q = function(e) {
        ...
        function ee(e, t, i) {
            ...
            if (e && 'addEventListener' in e && !X(t) && V(i)) {
                var o = t.split(' '),
                    l = r;
                Z && (l = { passive: s, capture: r }),
                    o.forEach(function(t) {
                        n &&
                            n.eventListeners &&
                            a &&
                            n.eventListeners.push({ element: e, type: t, callback: i, options: l }),
        ...
        function re() {
            ...
            return new Promise(function(t) {
                return e.ready ? setTimeout(t, 0) : te.call(e, e.elements.container, 'ready', t);
            }).then(function() {});
        }
        function oe(e, t) {
        ...
        function le() {
            ...
            return D(s)
                ? (Object.keys(s).forEach(function(t) {
                      D(s[t])
                          ? (Object.keys(e).includes(t) || Object.assign(e, n({}, t, {})), le(e[t], s[t]))
        ...
        function he(e, t, i, n) {
            z(t) && t.appendChild(de(e, i, n));
        }
        function pe(e) {
            U(e) || B(e) ? Array.from(e).forEach(pe) : z(e) && z(e.parentNode) && e.parentNode.removeChild(e);
        }
        function me(e) {
        ...
        function Ce() {
            ...
            if (z(e)) {
                var i = ke.call(this, 'button:not(:disabled), input:not(:disabled), [tabindex]'),
                    n = i[0],
                    a = i[i.length - 1],
                    s = function(e) {
        ...
        function Ae() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            z(e) && (e.focus({ preventScroll: !0 }), t && ve(e, this.config.classNames.tabFocus));
        }
        var Ee,
            Se = {
                'audio/ogg': 'vorbis',
            ...
            Pe = {
                ...
                check: function(e, t, i) {
                    var n = G.isIPhone && i && Pe.playsinline,
                        a = Pe[e] || 'html5' !== t;
                    return {
                        api: a,
                ...
                pip: !(
                    G.isIPhone ||
                    (!V(de('video').webkitSetPresentationMode) &&
                        (!document.pictureInPictureEnabled || de('video').disablePictureInPicture))
                ),
        ...
        function Ne(e) {
            return !!(B(e) || (F(e) && e.includes(':'))) && (B(e) ? e : e.split(':')).map(Number).every(H);
        }
        function Me(e) {
            if (!B(e) || !e.every(H)) return null;
            var t = r(e, 2),
                i = t[0],
                n = t[1],
                a = (function e(t, i) {
                                    ...
                                    (e.media.src = i.getAttribute('src')),
                                        ('none' !== r || o) &&
                                            (e.once('loadedmetadata', function() {
                                                0 !== e.currentTime && ((e.currentTime = a), s || e.play());
                                            }),
                                            e.media.load());
                                }
        ...
        var Qe = {
            ...
            findElements: function() {
                try {
                    return (
                        (this.elements.controls = Te.call(this, this.config.selectors.controls.wrapper)),
            ...
            createBadge: function(e) {
                ...
                return t.appendChild(de('span', { class: this.config.classNames.menu.badge }, e)), t;
            },
            createButton: function(e, t) {
                ...
                return (
                    s.toggle
                        ? (r.appendChild(Qe.createIcon.call(this, s.iconPressed, { class: 'icon--pressed' })),
                          r.appendChild(Qe.createIcon.call(this, s.icon, { class: 'icon--not-pressed' })),
                          r.appendChild(Qe.createLabel.call(this, s.labelPressed, { class: 'label--pressed' })),
                          r.appendChild(Qe.createLabel.call(this, s.label, { class: 'label--not-pressed' })))
                        : (r.appendChild(Qe.createIcon.call(this, s.icon)),
                          r.appendChild(Qe.createLabel.call(this, s.label))),
                    le(n, ge(this.config.selectors.buttons[a], n)),
                    ue(r, n),
                    'play' === a
            ...
            createRange: function(e, t) {
                var i = de(
                    'input',
                    le(
                        ge(this.config.selectors.inputs[e]),
                        {
                            type: 'range',
                            min: 0,
                            max: 100,
                ...
                return (this.elements.inputs[e] = i), Qe.updateRangeFill.call(this, i), P.setup(i), i;
            },
            createProgress: function(e, t) {
                var i = de(
                    'progress',
                    le(
                        ge(this.config.selectors.display[e]),
                        {
                            min: 0,
                            max: 100,
                            value: 0,
            ...
            createTime: function(e, t) {
                var i = ge(this.config.selectors.display[e], t),
                    n = de(
                        'div',
                        le(i, {
                            class: ''
                ...
                te.call(
                    ...
                    function(n) {
                        if (
                            ...
                            var a,
                                s = we(e, '[role="menuitemradio"]');
                            if (!s && [32, 39].includes(n.which)) Qe.showMenuPanel.call(i, t, !0);
                            else
                                32 !== n.which &&
            ...
            createMenuItem: function(e) {
                var t = this,
                    ...
                    l = e.checked,
                    c = void 0 !== l && l,
                    u = ge(this.config.selectors.inputs[a]),
                    d = de(
                        'button',
                        le(u, {
                            type: 'button',
                ...
                (h.innerHTML = s),
                        ...
                        set: function(e) {
                            e &&
                                Array.from(d.parentNode.children)
                                    .filter(function(e) {
                                        return we(e, '[role="menuitemradio"]');
                                    })
                                    .forEach(function(e) {
                    ...
                    Qe.bindMenuItemShortcuts.call(this, d, a),
                    n.appendChild(d);
            },
            formatTime: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            ...
            updateTimeDisplay: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                    ...
                    i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                z(e) && H(t) && (e.innerText = Qe.formatTime(t, i));
            },
            updateVolume: function() {
                this.supported.ui &&
                    (z(this.elements.inputs.volume) &&
                        Qe.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                    z(this.elements.buttons.mute) &&
                        (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
            },
            setRange: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
                z(e) && ((e.value = t), Qe.updateRangeFill.call(this, e));
            },
                                ...
                                (i = this.currentTime),
                                    ...
                                    (a =
                                        0 === i || 0 === n || Number.isNaN(i) || Number.isNaN(n)
                                            ? 0
                                            : ((i / n) * 100).toFixed(2)),
                                    'timeupdate' === e.type && Qe.setRange.call(this, this.elements.inputs.seek, a);
                                break;
                            case 'playing':
                            case 'progress':
                                !(function(e, i) {
            ...
            updateSeekTooltip: function(e) {
                ...
                if (
                    ...
                    var i = ''.concat(this.config.classNames.tooltip, '--visible'),
                        n = function(e) {
                            return ve(t.elements.display.seekTooltip, i, e);
                        };
                    if (this.touch) n(!1);
                    else {
                        var a = 0,
                            s = this.elements.progress.getBoundingClientRect();
                        if (W(e)) a = (100 / s.width) * (e.pageX - s.left);
                        else {
                            if (!be(this.elements.display.seekTooltip, i)) return;
                        ...
                        a < 0 ? (a = 0) : a > 100 && (a = 100),
                            ...
                            W(e) && ['mouseenter', 'mouseleave'].includes(e.type) && n('mouseenter' === e.type);
                    }
                }
            },
            ...
            durationUpdate: function() {
                if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                    if (this.duration >= Math.pow(2, 32))
                        return ye(this.elements.display.currentTime, !0), void ye(this.elements.progress, !0);
                    z(this.elements.inputs.seek) &&
                    ...
                    !e &&
                        ...
                        this.paused &&
                        Qe.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                        e && Qe.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
                        Qe.updateSeekTooltip.call(this);
                }
            },
            toggleMenuButton: function(e, t) {
                ye(this.elements.settings.buttons[e], !t);
            },
            ...
            setQualityMenu: function(e) {
                ...
                if (z(this.elements.settings.panels.quality)) {
                    ...
                    B(e) &&
                        (this.options.quality = _e(e).filter(function(e) {
                            return t.config.quality.options.includes(e);
                        }));
                    var n = !X(this.options.quality) && this.options.quality.length > 1;
                    if ((Qe.toggleMenuButton.call(this, 'quality', n), me(i), Qe.checkMenu.call(this), n)) {
                        var a = function(e) {
            ...
            setCaptionsMenu: function() {
                ...
                if (z(this.elements.settings.panels.captions)) {
                    var t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                        ...
                        n = Boolean(i.length);
                    if ((Qe.toggleMenuButton.call(this, 'captions', n), me(t), Qe.checkMenu.call(this), n)) {
                        var a = i.map(function(i, n) {
                            return {
                                value: n,
                                checked: e.captions.toggled && e.currentTrack === n,
                                title: $e.getLabel.call(e, i),
                                badge: i.language && Qe.createBadge.call(e, i.language.toUpperCase()),
                                list: t,
                                type: 'language',
                            };
                        });
            ...
            setSpeedMenu: function(e) {
                ...
                if (z(this.elements.settings.panels.speed)) {
                    ...
                    Qe.toggleMenuButton.call(this, 'speed', n),
                        me(i),
            ...
            checkMenu: function() {
                ...
                ye(this.elements.settings.menu, !t);
            },
            ...
            toggleMenu: function(e) {
                ...
                if (z(t) && z(i)) {
                    ...
                    i.setAttribute('aria-expanded', a),
                        ...
                        a && K(e) ? Qe.focusFirstMenuItem.call(this, null, !0) : a || n || Ae.call(this, i, K(e));
                }
            },
            ...
            showMenuPanel: function() {
                ...
                if (z(n)) {
                    ...
                    if (Pe.transitions && !Pe.reducedMotion) {
                        ...
                        var r = Qe.getMenuSize.call(this, n),
                            o = function t(i) {
                                i.target === a &&
            ...
            create: function(e) {
                ...
                return (
                    _e(this.config.controls).forEach(function(o) {
                        if (
                            ...
                            var l = de('div', { class: ''.concat(d.class, ' plyr__progress__container') }),
                            ...
                            if (
                                ...
                                var p = de('span', { class: t.config.classNames.tooltip }, '00:00');
                        ...
                        if (
                            ...
                            if (
                                ...
                                m.appendChild(s.call(t, 'volume', le(f, { id: 'plyr-volume-'.concat(e.id) })));
                            }
                        }
                        if (
                            ...
                            b.appendChild(w),
                                ...
                                t.config.settings.forEach(function(n) {
                                    var a = de(
                                        'button',
                                        le(ge(t.config.selectors.buttons.settings), {
                                            type: 'button',
                                            class: ''
                                    ...
                                    var o = de('div', { id: 'plyr-settings-'.concat(e.id, '-').concat(n), hidden: '' }),
                                        l = de('button', {
                                            type: 'button',
                                            class: ''
                                                .concat(t.config.classNames.control, ' ')
                                    ...
                                    l.appendChild(de('span', { 'aria-hidden': !0 }, Re(n, t.config))),
                                        l.appendChild(
                                            de('span', { class: t.config.classNames.hidden }, Re('menuBack', t.config)),
                                        ),
                                        te.call(
                                            t,
                                            o,
                                        ...
                                        te.call(t, l, 'click', function() {
                                            c.call(t, 'home', !1);
                                        }),
                                        o.appendChild(l),
                                        o.appendChild(de('div', { role: 'menu' })),
                                        v.appendChild(o),
                        ...
                        if (
                            ('pip' === o && Pe.pip && u.appendChild(n.call(t, 'pip', d)),
                            'airplay' === o && Pe.airplay && u.appendChild(n.call(t, 'airplay', d)),
                            'download' === o)
                        ) {
                            var k = le({}, d, { element: 'a', href: t.download, target: '_blank' }),
                                T = t.config.urls.download;
                            !Q(T) && t.isEmbed && le(k, { icon: 'logo-'.concat(t.provider), label: t.provider }),
            ...
            inject: function() {
                ...
                if (
                    (a && (F(this.config.controls) ? (i = o(i)) : z(i) && (i.innerHTML = o(i.innerHTML))),
                    ...
                    s[z(i) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', i),
                ...
                if ((G.isEdge && $(s), this.config.tooltips.controls)) {
                    ...
                    Array.from(p).forEach(function(t) {
                        ve(t, e.config.classNames.hidden, !1), ve(t, e.config.classNames.tooltip, !0);
                    });
                }
            },
        };
        ...
        var $e = {
                        ...
                        if (!this.isVideo || this.isYouTube || (this.isHTML5 && !Pe.textTracks))
                            ...
                            if (
                                (z(this.elements.captions) ||
                                    ((this.elements.captions = de('div', ge(this.config.selectors.captions))),
                                    (function(e, t) {
                            ...
                            if (
                                ...
                                Object.assign(this.captions, { toggled: !1, active: n, language: i, languages: t }),
                                this.isHTML5)
                            ) {
                        ...
                        t
                            ...
                            .forEach(function(t) {
                                e.debug.log('Track added', t),
                                    ...
                                    (t.mode = 'hidden'),
                                    te.call(e, t, 'cuechange', function() {
                                        return $e.updateCues.call(e);
                                    });
                            }),
                        ((o && this.language !== a) || !t.includes(r)) &&
                            ($e.setLanguage.call(this, a), $e.toggle.call(this, n && o)),
                        ve(this.elements.container, this.config.classNames.captions.enabled, !X(t)),
                        (this.config.controls || []).includes('settings') &&
                            this.config.settings.includes('captions') &&
                            Qe.setCaptionsMenu.call(this);
                },
                    ...
                    if (this.supported.ui) {
                        ...
                        if (a !== i) {
                            if (
                                ...
                                return (this.captions.language = r.language), void $e.set.call(this, s.indexOf(r));
                            }
                    ...
                    if (-1 !== e)
                        if (H(e))
                            if (e in i) {
                                ...
                                $e.toggle.call(this, !0, t), this.isHTML5 && this.isVideo && $e.updateCues.call(this);
                ...
                getLabel: function(e) {
                    var t = e;
                    return (
                        !Y(t) && Pe.textTracks && this.captions.toggled && (t = $e.getCurrentTrack.call(this)),
                        Y(t)
                            ? X(t.label)
                                ? X(t.language)
                                    ? Re('enabled', this.config)
                                    : e.language.toUpperCase()
                                : t.label
                            : Re('disabled', this.config)
                    );
                },
            ...
            et = 'inline',
            tt = { html5: 'html5', youtube: 'youtube', vimeo: 'vimeo' },
            it = 'audio',
            nt = 'video';
        var at = function() {},
            st = (function() {
        ...
        var lt = (function() {
            function t(i) {
                ...
                e(this, t),
                    ...
                    te.call(this.player, this.player.elements.container, 'dblclick', function(e) {
                        ...
                        },
                        {
                            ...
                            value: function() {
                                if (this.enabled)
                                    ...
                                    else if (!t.native || this.forceFallback) ot.call(this, !1);
                                    else if (this.prefix) {
                                        if (!X(this.prefix)) {
                        ...
                        },
                        {
                            ...
                            get: function() {
                                return (
                                    !!this.enabled &&
                                    (!t.native || this.forceFallback
                                        ? be(this.target, this.player.config.classNames.fullscreen.fallback)
                                        : (this.prefix
        ...
        var ut = {
                addStyleHook: function() {
                    ve(this.elements.container, this.config.selectors.container.replace('.', ''), !0),
                        ve(this.elements.container, this.config.classNames.uiSupported, this.supported.ui);
                },
                ...
                build: function() {
                    ...
                    z(this.elements.controls) || (Qe.inject.call(this), this.listeners.controls()),
                        ...
                        ve(this.elements.container, this.config.classNames.isTouch, this.touch),
                        (this.ready = !0),
                        setTimeout(function() {
                            ae.call(e, e.media, 'ready');
                        }, 0),
                        ut.setTitle.call(this),
                        this.poster && ut.setPoster.call(this, this.poster, !1).catch(function() {}),
                ...
                togglePoster: function(e) {
                    ve(this.elements.container, this.config.classNames.posterEnabled, e);
                },
                ...
                checkPlaying: function(e) {
                    ...
                    ve(this.elements.container, this.config.classNames.playing, this.playing),
                        ve(this.elements.container, this.config.classNames.paused, this.paused),
                        ve(this.elements.container, this.config.classNames.stopped, this.stopped),
                        Array.from(this.elements.buttons.play || []).forEach(function(e) {
                            Object.assign(e, { pressed: t.playing }),
                                e.setAttribute('aria-label', Re(t.playing ? 'pause' : 'play', t.config));
                        }),
                        (W(e) && 'timeupdate' === e.type) || ut.toggleControls.call(this);
                },
                    ...
                    i(t, [
                        {
                            ...
                            value: function(e) {
                                var t = this.player,
                                    ...
                                    a = 'keydown' === e.type,
                                    s = a && n === this.lastKey;
                                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && H(n)) {
                                    if (a) {
                                        var r = document.activeElement;
                                        if (z(r)) {
                                            var o = t.config.selectors.editable;
                                            if (r !== i.inputs.seek && we(r, o)) return;
                                            if (32 === e.which && we(r, 'button, [role^="menuitem"]')) return;
                                        }
                                        switch (
                                            ([
                                                32,
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e = this.player,
                                    t = e.elements;
                                (e.touch = !0), ve(t.container, e.config.classNames.isTouch, !0);
                            },
                        },
                        {
                            key: 'setTabFocus',
                                        ...
                                        (n = t.config.classNames.tabFocus),
                                            ...
                                            (this.focusTimer = setTimeout(function() {
                                                ...
                                                i.container.contains(e) &&
                                                    ve(document.activeElement, t.config.classNames.tabFocus, !0);
                                            }, 10));
                                }
                            },
                        },
                        {
                            ...
                            value: function() {
                                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                                    t = this.player;
                                t.config.keyboard.global && ee.call(t, window, 'keydown keyup', this.handleKey, e, !1),
                                    ee.call(t, document.body, 'click', this.toggleMenu, e),
                                    ne.call(t, document.body, 'touchstart', this.firstTouch),
                                    ee.call(t, document.body, 'keydown focus blur', this.setTabFocus, e, !1, !0);
                            },
                        },
                        {
                            key: 'container',
                            value: function() {
                                ...
                                !t.keyboard.global &&
                                    t.keyboard.focused &&
                                    te.call(e, i.container, 'keydown keyup', this.handleKey, !1),
                                    te.call(
                                        e,
                                        i.container,
                                        ...
                                        function(t) {
                                            ...
                                            ['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                                                (ut.toggleControls.call(e, !0), (s = e.touch ? 3e3 : 2e3)),
                                ...
                                te.call(e, i.container, 'enterfullscreen exitfullscreen', function(t) {
                                    var n = e.fullscreen,
                                        o = n.target,
                                        l = n.usingNative;
                                    if (o === i.container && (e.isEmbed || !X(e.config.ratio))) {
                                        ...
                                        !(function(t, i, n) {
                                            ...
                                            l ||
                                                (c ? te.call(e, window, 'resize', s) : ie.call(e, window, 'resize', s));
                                    }
                                });
                            },
                        },
                        {
                            ...
                            value: function() {
                                var e = this,
                                    ...
                                    i = t.elements;
                                if (
                                    (te.call(t, t.media, 'timeupdate seeking seeked', function(e) {
                                        return Qe.timeUpdate.call(t, e);
                                    }),
                                    te.call(t, t.media, 'durationchange loadeddata loadedmetadata', function(e) {
                                        return Qe.durationUpdate.call(t, e);
                                    }),
                                    te.call(t, t.media, 'ended', function() {
                                        t.isHTML5 && t.isVideo && t.config.resetOnEnd && (t.restart(), t.pause());
                                    }),
                                    te.call(t, t.media, 'progress playing seeking seeked', function(e) {
                                        return Qe.updateProgress.call(t, e);
                                    }),
                                    te.call(t, t.media, 'volumechange', function(e) {
                                        return Qe.updateVolume.call(t, e);
                                    }),
                                    te.call(t, t.media, 'playing play pause ended emptied timeupdate', function(e) {
                                        return ut.checkPlaying.call(t, e);
                                    }),
                                    te.call(t, t.media, 'waiting canplay seeked playing', function(e) {
                                        return ut.checkLoading.call(t, e);
                                    }),
                                    t.supported.ui && t.config.clickToPlay && !t.isAudio)
                                ) {
                                    var n = Te.call(t, '.'.concat(t.config.classNames.video));
                                    if (!z(n)) return;
                                ...
                                t.supported.ui &&
                                    ...
                                    te.call(t, t.media, 'ratechange', function() {
                                        Qe.updateSetting.call(t, 'speed'), t.storage.set({ speed: t.speed });
                                    }),
                                    te.call(t, t.media, 'qualitychange', function(e) {
                                        Qe.updateSetting.call(t, 'quality', null, e.detail.quality);
                                    }),
                                    te.call(t, t.media, 'ready qualitychange', function() {
                                        Qe.setDownloadUrl.call(t);
                                    });
                            ...
                            value: function() {
                                ...
                                if (
                                    ...
                                    this.bind(i.buttons.settings, 'click', function(e) {
                                        e.stopPropagation(), Qe.toggleMenu.call(t, e);
                                    }),
                                    this.bind(
                                        i.buttons.settings,
                                        'keyup',
                                        function(e) {
                                            ...
                                            [13, 32].includes(i) &&
                                                (13 !== i
                                                    ...
                                                    : Qe.focusFirstMenuItem.call(t, null, !0));
                                        },
                                        null,
                                        !1,
                                    ),
                                ...
                                this.bind(
                                    ...
                                    G.isWebkit &&
                                        Array.from(ke.call(t, 'input[type="range"]')).forEach(function(i) {
                                            e.bind(i, 'input', function(e) {
                                                return Qe.updateRangeFill.call(t, e.target);
                                            });
                                        }),
                                    t.config.toggleInvert &&
                                        !z(i.display.duration) &&
                                        this.bind(i.display.currentTime, 'click', function() {
                                            0 !== t.currentTime &&
                                                ((t.config.invertTime = !t.config.invertTime), Qe.timeUpdate.call(t));
                                        }),
                                    this.bind(
                                        i.inputs.volume,
                                        n,
                                    ...
                                    this.bind(i.controls, 'mousedown mouseup touchstart touchend touchcancel', function(
                                        e,
                                    ) {
                                    ...
                                    this.bind(i.controls, 'focusin', function() {
                                        ...
                                        ve(i.controls, n.classNames.noTransition, !0),
                                            ...
                                            setTimeout(function() {
                                                ve(i.controls, n.classNames.noTransition, !1);
                                            }, 0);
        ...
        function mt(e) {
            e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
                this.media.paused === e && ((this.media.paused = !e), ae.call(this, this.media, e ? 'play' : 'pause'));
        }
        var ft = {
            setup: function() {
                var e = this;
            ...
            ready: function() {
                ...
                Object.defineProperty(t.media, 'playbackRate', {
                    ...
                    set: function(e) {
                        t.embed
                            ...
                            .catch(function(e) {
                                'Error' === e.name && Qe.setSpeedMenu.call(t, []);
                            });
                    },
                });
                ...
                Object.defineProperty(t.media, 'loop', {
                    ...
                    t.embed.getVideoTitle().then(function(i) {
                        (t.config.title = i), ut.setTitle.call(e);
                    }),
        ...
        var vt = {
            ...
            bt = {
                setup: function() {
                    this.media
                        ? (ve(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
                          ve(
                              this.elements.container,
                          ...
                          this.isEmbed &&
                              ve(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
                          this.isVideo &&
                              ((this.elements.wrapper = de('div', { class: this.config.classNames.video })),
                              ce(this.media, this.elements.wrapper),
                              this.isEmbed &&
                                  ((this.elements.poster = de('div', { class: this.config.classNames.poster })),
                ...
                return (
                    i(t, [
                        ...
                        },
                        {
                            key: 'setupIMA',
                            value: function() {
                                (this.elements.container = de('div', { class: this.player.config.classNames.ads })),
                            ...
                            value: function() {
                                ...
                                var i = function() {
                                    var t = Ye(Math.max(e.manager.getRemainingTime(), 0)),
                                        i = ''.concat(Re('advertisement', e.player.config), ' - ').concat(t);
                                        ...
                                        if (0 !== t && -1 !== t && t < e.player.duration) {
                                            ...
                                            if (z(i)) {
                                                var n = (100 / e.player.duration) * t,
                                                    a = de('span', { class: e.player.config.classNames.cues });
                            ...
                            value: function() {
                                ...
                                this.player.on('canplay', function() {
                                    ...
                                    window.addEventListener('resize', function() {
                                        t.manager &&
                                            t.manager.resize(i.offsetWidth, i.offsetHeight, google.ima.ViewMode.NORMAL);
                                    });
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                for (
                                    var t = this, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), a = 1;
                                    a < i;
                                    a++
                                )
                                    n[a - 1] = arguments[a];
                ...
                return (
                    i(t, [
                            ...
                            value: function() {
                                ...
                                (this.mouseDown = !1),
                                    Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime)
                                        ...
                                        : ne.call(this.player, this.player.media, 'timeupdate', function() {
                        ...
                        },
                        {
                            key: 'render',
                            value: function() {
                                (this.elements.thumb.container = de('div', {
                                        ...
                                        s < this.thumbContainerHeight &&
                                            setTimeout(function() {
                                                a.showingThumbFilename === n &&
                                                    (a.player.debug.log('Showing higher quality thumb for: '.concat(n)),
                                                    a.loadImage(e + 1));
                                            }, 300);
                                }
                            },
                          ...
                          this.destroy.call(
                              ...
                              function() {
                                  (t.options.quality = []),
                                      pe(t.media),
                                      (t.media = null),
                                      z(t.elements.container) && t.elements.container.removeAttribute('class');
                                  var i = e.sources,
                                      n = e.type,
                                      a = r(i, 1)[0],
                                      s = a.provider,
                                      o = void 0 === s ? tt.html5 : s,
                                      l = a.src,
                                      c = 'html5' === o ? n : 'div',
                                      u = 'html5' === o ? {} : { src: l };
                                  Object.assign(t, {
                                      ...
                                      (t.isHTML5 || (t.isEmbed && !t.supported.ui)) && ut.build.call(t),
            ...
            Et = (function() {
                function t(i, n) {
                    ...
                    if (
                        ...
                        ((window.jQuery && this.media instanceof jQuery) || U(this.media) || B(this.media)) &&
                            ...
                            if (Pe.check().api) {
                                ...
                                switch (r) {
                                    case 'div':
                                        ...
                                        if (X(this.provider) || !Object.keys(tt).includes(this.provider))
                                ...
                                (this.supported = Pe.check(this.type, this.provider, this.config.playsinline)),
                                    this.supported.api
                                        ? ((this.eventListeners = []),
                                          ...
                                          (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && ut.build.call(this),
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    if (this.supported.ui && !this.isAudio) {
                                        var t = be(this.elements.container, this.config.classNames.hideControls),
                                            i = void 0 === e ? void 0 : !e,
                                            n = ve(this.elements.container, this.config.classNames.hideControls, i);
                                        if (
                                            (n &&
                                                this.config.controls.includes('settings') &&
                            ...
                            },
                            {
                                ...
                                get: function() {
                                    ...
                                    return H(e) ? e : e && e.length && this.duration > 0 ? e.end(0) / this.duration : 0;
                                },
                            },
                            {
                                key: 'seeking',
                            ...
                            },
                            {
                                ...
                                set: function(e) {
                                    Q(e) && ((this.config.urls.download = e), Qe.setDownloadUrl.call(this));
                                },
                            },
                            {
                                key: 'poster',
        ...
        return (Et.defaults = ((At = Ge), JSON.parse(JSON.stringify(At)))), Et;
    });
