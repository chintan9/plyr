typeof navigator === "object" && (function () {
  ...
  var global_1 =
      ...
      check(typeof window == O && window) || check(typeof self == O && self) ||
  ...
  var redefine = createCommonjsModule(function(module) {
    ...
    shared('inspectSource', function(it) { return functionToString.call(it); });
  ...
  */
  ...
  var wellKnownSymbol = function(name) {
    return store$1[name] ||
           (store$1[name] = nativeSymbol && Symbol$1[name] ||
  ...
  var arrayFrom = function from(
    ...
    if (mapping)
      mapfn =
          bindContext(mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2);
  ...
  var wrappedWellKnownSymbol = {f : f$6};
  ...
  var defineWellKnownSymbol = function(NAME) {
    ...
    if (!has(Symbol, NAME))
      defineProperty$1(Symbol, NAME, {value : wrappedWellKnownSymbol.f(NAME)});
  };
  ...
  var isSymbol = nativeSymbol && typeof $Symbol.iterator == 'symbol'
  ...
  if (!nativeSymbol) {
    ...
    wrappedWellKnownSymbol.f = function(
  ...
  $forEach$1(objectKeys(WellKnownSymbolsStore),
  ...
  fixRegexpWellKnownSymbolLogic(
      'replace', 2, function(REPLACE, nativeReplace, maybeCallNative) {
        return [
      ...
      if (domIterables[COLLECTION_NAME$1])
        for (var METHOD_NAME in es_array_iterator) {
          ...
          if (CollectionPrototype$1[METHOD_NAME] !==
            ...
            try {
              hide(CollectionPrototype$1, METHOD_NAME,
                   es_array_iterator[METHOD_NAME]);
            } catch (error) {
  ...
  var nativeUrl = !fails(function() {
    ...
    return (isPure && !url.toJSON) || !searchParams.sort ||
           url.href !== 'http://a/c%20d?e=1' || searchParams.get('e') !== '1' ||
  ...
  var arrayLastIndexOf =
      (NEGATIVE_ZERO$1 || SLOPPY_METHOD$2) ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
        // convert -0 to +0
        if (NEGATIVE_ZERO$1)
        ...
        if (arguments.length > 1)
          index = min$4(index, toInteger(arguments[1]));
        if (index < 0)
          index = length + index;
        for (; index >= 0; index--)
  ...
  if (!set$1 || !clear) {
    ...
    if (classofRaw(process) == 'process') {
      defer = function(id) { process.nextTick(runner(id)); };
  ...
  if (!queueMicrotask) {
    ...
    // Node.js
    if (IS_NODE) {
      notify = function() { process$1.nextTick(flush); };
      // browsers with MutationObserver, except iOS -
      // https://github.com/zloirock/core-js/issues/339
    } else if (MutationObserver$1 &&
               !/(iphone|ipod|ipad).*applewebkit/i.test(userAgent)) {
      toggle = true;
      node = document.createTextNode('');
      new MutationObserver$1(flush).observe(
          node, {characterData : true}); // eslint-disable-line no-new
  ...
  var FORCED$1 = isForced_1(PROMISE, function() {
    ...
    var empty = function() { /* empty */ };
    var FakePromise = (promise.constructor = {})[SPECIES$6] = function(
        exec) { exec(empty, empty); };
  ...
  var INCORRECT_ITERATION$1 =
      FORCED$1 || !checkCorrectnessOfIteration(function(iterable) {
  ...
  var FORCED$2 =
      descriptors && isForced_1('RegExp', (!CORRECT_NEW || fails(function() {
                                  re2[MATCH$2] = false;
                                  // RegExp constructor can alter flags and
                                  // IsRegExp works correct with @@match
                                  return NativeRegExp(re1) != re1 ||
  ...
  if (FORCED$2) {
    var RegExpWrapper = function RegExp(pattern, flags) {
      ...
      return !thisIsRegExp && patternIsRegExp &&
                 ...
                 : inheritIfRequired(
                       CORRECT_NEW
                           ? new NativeRegExp(patternIsRegExp &&
                                                      !flagsAreUndefined
                                                  ? pattern.source
                                                  : pattern,
                                              flags)
                           : NativeRegExp((patternIsRegExp =
                                               pattern instanceof RegExpWrapper)
                                              ? pattern.source
                                              : pattern,
  ...
  if (NATIVE_ARRAY_BUFFER && objectSetPrototypeOf &&
  ...
  var typedArraysConstructorsRequiresWrappers =
  ...
  var arrayBuffer = createCommonjsModule(function(module, exports) {
    ...
    var packIEEE754 = function(number, mantissaLength, bytes) {
      ...
      for (; mantissaLength >= 8; buffer[index++] = mantissa & 255,
                                  mantissa /= 256, mantissaLength -= 8)
        ;
      exponent = exponent << mantissaLength | mantissa;
      exponentLength += mantissaLength;
      for (; exponentLength > 0; buffer[index++] = exponent & 255,
    ...
    if (!NATIVE_ARRAY_BUFFER) {
      ...
      redefineAll($DataView[PROTOTYPE], {
        getInt8 : function getInt8(
            byteOffset) { return get(this, 1, byteOffset)[0] << 24 >> 24; },
        getUint8 : function getUint8(
            byteOffset) { return get(this, 1, byteOffset)[0]; },
        getInt16 : function getInt16(byteOffset /* , littleEndian */) {
          var bytes = get(this, 2, byteOffset,
                          arguments.length > 1 ? arguments[1] : undefined);
        ...
        getFloat64 : function getFloat64(byteOffset /* , littleEndian */) {
          return unpackIEEE754(
              get(this, 8, byteOffset,
                  arguments.length > 1 ? arguments[1] : undefined),
              52);
        },
        setInt8 : function setInt8(
            byteOffset, value) { set(this, 1, byteOffset, packInt8, value); },
        setUint8 : function setUint8(
            byteOffset, value) { set(this, 1, byteOffset, packInt8, value); },
        setInt16 : function setInt16(byteOffset, value /* , littleEndian */) {
          set(this, 2, byteOffset, packInt16, value,
        ...
        setInt32 : function setInt32(byteOffset, value /* , littleEndian */) {
          set(this, 4, byteOffset, packInt32, value,
              arguments.length > 2 ? arguments[2] : undefined);
        },
        ...
        setFloat32 : function setFloat32(byteOffset,
                                         value /* , littleEndian */) {
          set(this, 4, byteOffset, packFloat32, value,
              arguments.length > 2 ? arguments[2] : undefined);
        },
        setFloat64 : function setFloat64(byteOffset,
                                         value /* , littleEndian */) {
          set(this, 8, byteOffset, packFloat64, value,
              arguments.length > 2 ? arguments[2] : undefined);
        }
      });
    } else {
      if (!fails(function() { NativeArrayBuffer(1); }) || !fails(function() {
        ...
        for (var keys = getOwnPropertyNames(NativeArrayBuffer), j = 0, key;
             keys.length > j;) {
    ...
    if (descriptors) {
      ...
      module.exports = function(TYPE, BYTES, wrapper, CLAMPED) {
            ...
            if (isArrayBuffer(data))
              return $length !== undefined
                         ? new NativeTypedArrayConstructor(
                               data, toOffset(typedArrayOffset, BYTES), $length)
          ...
          forEach(getOwnPropertyNames(NativeTypedArrayConstructor),
                  function(key) {
                    if (!(key in TypedArrayConstructor))
                      hide(TypedArrayConstructor, key,
        ...
        if (TypedArrayConstructorPrototype.constructor !==
            TypedArrayConstructor) {
          hide(TypedArrayConstructorPrototype, 'constructor',
               TypedArrayConstructor);
        }

        if (TYPED_ARRAY_TAG)
          hide(TypedArrayConstructorPrototype, TYPED_ARRAY_TAG,
               CONSTRUCTOR_NAME);
  ...
  arrayBufferViewCore.exportProto(
      'set', function set(arrayLike /* , offset */) {
        aTypedArray$h(this);
        var offset =
            toOffset(arguments.length > 1 ? arguments[1] : undefined, 1);
  ...
  arrayBufferViewCore.exportProto('toString', arrayToString,
                                  (Uint8ArrayPrototype || {}).toString !=
                                      arrayToString);
  ...
  */
  ...
  if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') ||
    ...
    for (
      ...
      if (has(NativeNumber, key = keys$2[j]) && !has(NumberWrapper, key)) {
        defineProperty$6(NumberWrapper, key,
  ...
  var nativeWeakMap$1 = typeof WeakMap$3 === 'function' &&
                        /native code/.test(inspectSource(WeakMap$3));
  ...
  var sharedKey$1 = function(
      key) { return keys$3[key] || (keys$3[key] = uid$1(key)); };
  ...
  var enforce$1 = function(
      it) { return has$3(it) ? get$1(it) : set$2(it, {}); };
  ...
  if (nativeWeakMap$1) {
    ...
    get$1 = function(it) { return wmget$1.call(store$3, it) || {}; };
    ...
    get$1 = function(it) { return has$2(it, STATE$1) ? it[STATE$1] : {}; };
  ...
  var toInteger$1 = function(argument) {
    return isNaN(argument = +argument)
               ? 0
               : (argument > 0 ? floor$5 : ceil$1)(argument);
  };
  ...
  */
  ...
  var createWellKnownSymbol =
      useSymbolAsUid ? Symbol$2 : Symbol$2 && Symbol$2.withoutSetter || uid$1;
  ...
  var IS_CONCAT_SPREADABLE_SUPPORT$1 =
      engineV8Version >= 51 || !fails$1(function() {
        var array = [];
  ...
  var arrayMethodUsesToLength = function(METHOD_NAME, options) {
    ...
    return cache[METHOD_NAME] = !!method && !fails$1(function() {
             ...
             if (ACCESSORS)
               defineProperty$7(O, 1, {enumerable : true, get : thrower});
             else
               O[1] = 1;
  ...
  var NullProtoObject = function() {
    ...
    while (length--)
      delete NullProtoObject[PROTOTYPE$2][enumBugKeys$1[length]];
  ...
  var defineIterator$1 = function(Iterable, NAME, IteratorConstructor, next,
        ...
        if (objectGetPrototypeOf$1(CurrentIteratorPrototype) !==
          ...
          if (objectSetPrototypeOf$1) {
            objectSetPrototypeOf$1(CurrentIteratorPrototype,
                     ...
                     'function') {
            createNonEnumerableProperty(CurrentIteratorPrototype, ITERATOR$d,
                                        returnThis$5);
          }
        }
        // Set @@toStringTag to native iterators
    ...
    if (IterablePrototype[ITERATOR$d] !== defaultIterator) {
      createNonEnumerableProperty(IterablePrototype, ITERATOR$d,
                                  defaultIterator);
    }
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : ES3_STRINGS$1 || !STRICT_METHOD
  },
            {
              join : function join(separator) {
  ...
  if (isForced_1$1(NUMBER$1, !NativeNumber$1(' 0o1') ||
    ...
    for (
        var keys$4 =
                descriptors$1
                    ? getOwnPropertyNames$2(NativeNumber$1)
                    : (
                          // ES3:
                          'MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,' +
                          // ES2015 (in case, if modules with ES2015 Number
                          ...
                          .split(','),
            j$1 = 0, key$1;
        keys$4.length > j$1; j$1++) {
      if (has$2(NativeNumber$1, key$1 = keys$4[j$1]) &&
          !has$2(NumberWrapper$1, key$1)) {
        defineProperty$9(NumberWrapper$1, key$1,
                         getOwnPropertyDescriptor$6(NativeNumber$1, key$1));
      }
    }
  ...
  var objectToString$1 =
      toStringTagSupport ? {}.toString : function toString() {
  ...
  var PATCH$1 =
      UPDATES_LAST_INDEX_WRONG$1 || NPCG_INCLUDED$1 || UNSUPPORTED_Y$1;
  ...
  var fixRegexpWellKnownSymbolLogic$1 = function(KEY, length, exec, sham) {
    ...
    if (!DELEGATES_TO_SYMBOL || !DELEGATES_TO_EXEC ||
        (KEY === 'replace' &&
         !(REPLACE_SUPPORTS_NAMED_GROUPS$1 && REPLACE_KEEPS_$0 &&
  ...
  for (var COLLECTION_NAME$2 in domIterables$1) {
    ...
    if (CollectionPrototype$2) {
      ...
      if (CollectionPrototype$2[ITERATOR$e] !== ArrayValues$1)
        try {
          createNonEnumerableProperty(CollectionPrototype$2, ITERATOR$e,
                                      ArrayValues$1);
        } catch (error) {
          CollectionPrototype$2[ITERATOR$e] = ArrayValues$1;
        }
      if (!CollectionPrototype$2[TO_STRING_TAG$8]) {
        createNonEnumerableProperty(CollectionPrototype$2, TO_STRING_TAG$8,
                                    COLLECTION_NAME$2);
      }
      if (domIterables$1[COLLECTION_NAME$2])
        for (var METHOD_NAME$1 in es_array_iterator$1) {
          ...
          if (CollectionPrototype$2[METHOD_NAME$1] !==
            ...
            try {
              createNonEnumerableProperty(CollectionPrototype$2, METHOD_NAME$1,
                                          es_array_iterator$1[METHOD_NAME$1]);
            } catch (error) {
  ...
  var
      arrayForEach$1 =
          (!STRICT_METHOD$2 || !USES_TO_LENGTH$5) ? function forEach(callbackfn /* , thisArg */) {
  ...
  _export$1({
    target : 'Array',
    proto : true,
    forced : NEGATIVE_ZERO$2 || !STRICT_METHOD$3 || !USES_TO_LENGTH$6
  },
            {
              indexOf : function indexOf(searchElement /* , fromIndex = 0 */) {
  ...
  for (var COLLECTION_NAME$3 in domIterables$1) {
    ...
    if (CollectionPrototype$3 &&
      ...
      try {
        createNonEnumerableProperty(CollectionPrototype$3, 'forEach',
                                    arrayForEach$1);
      } catch (error) {
        CollectionPrototype$3.forEach = arrayForEach$1;
      }
  ...
  if (!nativeUrl$1 && typeof $fetch$1 == 'function' &&
  ...
  if (!set$3 || !clear$1) {
    ...
    if (classofRaw$1(process$4) == 'process') {
      defer$1 = function(id) { process$4.nextTick(runner$1(id)); };
      // Sphere (JS game engine) Dispatch API
  ...
  var task$2 = {set : set$3, clear : clear$1};
  ...
  if (!queueMicrotask$1) {
    flush$1 = function() {
      var parent, fn;
      if (IS_NODE$2 && (parent = process$5.domain))
        parent.exit();
      while (head$1) {
        fn = head$1.fn;
        head$1 = head$1.next;
    ...
    // Node.js
    if (IS_NODE$2) {
      notify$2 = function() { process$5.nextTick(flush$1); };
      // browsers with MutationObserver, except iOS -
      // https://github.com/zloirock/core-js/issues/339
      ...
      then = promise$1.then;
      notify$2 = function() { then.call(promise$1, flush$1); };
      // for other environments - macrotask based on:
      // - setImmediate
      // - MessageChannel
      // - window.postMessag
  ...
  var FORCED$8 = isForced_1$1(PROMISE$1, function() {
    var GLOBAL_CORE_JS_PROMISE =
        inspectSource(PromiseConstructor$1) !== String(PromiseConstructor$1);
    ...
    // https://github.com/zloirock/core-js/issues/679
    if (engineV8Version >= 51 && /native code/.test(PromiseConstructor$1))
      return false;
  ...
  var INCORRECT_ITERATION$3 =
      FORCED$8 || !checkCorrectnessOfIteration$1(function(iterable) {
  ...
  if (FORCED$8) {
    ...
    if (typeof nativePromiseConstructor == 'function') {
      ...
      redefine$1(nativePromiseConstructor.prototype,
                 'then', function then(onFulfilled, onRejected) {
                   var that = this;
      ...
      // wrap fetch result
      if (typeof $fetch$2 == 'function')
        _export$1({global : true, enumerable : true, forced : true}, {
          // eslint-disable-next-line no-unused-vars
          fetch : function fetch(input /* , init */) {
            return promiseResolve$1(PromiseConstructor$1,
                                    $fetch$2.apply(global_1$1, arguments));
          }
        });
    }
  }
