typeof navigator === 'object' &&
  ...
  */
    ...
    (function (global) {
      ...
      var checkIfURLSearchParamsSupported = function checkIfURLSearchParamsSupported() {
        try {
          ...
          return (
            new URLSearchParams('?a=1').toString() === 'a=1' && typeof URLSearchParams.prototype.set === 'function'
          );
        } catch (e) {
          return false;
        }
    ...
    var RangeTouch = (function () {
      function e(t, n) {
        _classCallCheck$1(this, e),
          is.element(t) ? (this.element = t) : is.string(t) && (this.element = document.querySelector(t)),
              ...
              value: function value(t) {
                ...
                if (
                  (is.empty(t) || is.string(t)
                    ? (r = Array.from(document.querySelectorAll(is.string(t) ? t : 'input[type="range"]')))
                    : is.element(t)
                    ? (r = [t])
                    : is.nodeList(t)
                    ? (r = Array.from(t))
    ...
    _export({ global: true, wrap: true, forced: FORCED$3 }, { Promise: PromiseConstructor });
    ...
    // statics
    _export(
      { target: PROMISE, stat: true, forced: FORCED$3 },
      {
